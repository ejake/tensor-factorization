...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_cef3ed4ef079aa71171effd3e7308370 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_cef3ed4ef079aa71171effd3e7308370() {
        ...
        ~__struct_compiled_op_cef3ed4ef079aa71171effd3e7308370(void) {
            cleanup();
        }
...
V19_0_tmp1 = V5_i - V7_i;
npy_int64 V19_0_tmp2;
V19_0_tmp2 = V19_0_tmp1 - V9_i;
npy_int64 V19_0_tmp3;

if (V19_0_tmp2 < 0) {
    if (V11_i < 0) {
        V19_0_tmp3 = ((-V19_0_tmp2) / (-V11_i));
    } else {
        V19_0_tmp3 = - ((-V19_0_tmp2) / V11_i) - ((THEANO_MACRO_MOD((-V19_0_tmp2), V11_i) == 0) ? 0 : 1);
    }
} else {
    if (V11_i < 0) {
        V19_0_tmp3 = - (V19_0_tmp2 / (-V11_i)) - ((THEANO_MACRO_MOD(V19_0_tmp2, (-V11_i)) == 0) ? 0 : 1);
...
V19_tmp1 = V19_0_tmp3 + V9_i;
}

npy_int64 V19_tmp2;
{
npy_int8 V19_1_tmp1;
V19_1_tmp1 = (V19_tmp1 < V13_i);
npy_int64 V19_1_tmp2;
V19_1_tmp2 = V19_1_tmp1 ? V13_i : V19_tmp1;
npy_int64 V19_1_tmp3;
V19_1_tmp3 = V19_1_tmp2 - V9_i;
npy_int64 V19_1_tmp4;
V19_1_tmp4 = V3_i - V19_1_tmp3;
V19_tmp2 = V19_1_tmp4 - V9_i;
}

npy_int64 V19_tmp3;
{
npy_int64 V19_2_tmp1;
V19_2_tmp1 = V3_i - V9_i;
npy_int8 V19_2_tmp2;
V19_2_tmp2 = (V19_tmp2 < V13_i);
...
{
npy_int8 V19_3_tmp1;
V19_3_tmp1 = (V19_tmp3 < V13_i);
V19_tmp4 = V19_3_tmp1 ? V13_i : V19_tmp3;
}

npy_int8 V19_tmp5;
V19_tmp5 = (V19_tmp4 < V15_i);
npy_int64 V19_tmp6;
V19_tmp6 = V19_tmp5 ? V19_tmp4 : V15_i;
npy_int64 V19_tmp7;
V19_tmp7 = V19_tmp6 - V17_i;
V1_i = V19_tmp7 - V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_cef3ed4ef079aa71171effd3e7308370_executor(__struct_compiled_op_cef3ed4ef079aa71171effd3e7308370* self) {
            return self->run();
        }

        static void __struct_compiled_op_cef3ed4ef079aa71171effd3e7308370_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_cef3ed4ef079aa71171effd3e7308370*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_cef3ed4ef079aa71171effd3e7308370* struct_ptr = new __struct_compiled_op_cef3ed4ef079aa71171effd3e7308370();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_cef3ed4ef079aa71171effd3e7308370_executor), struct_ptr, __struct_compiled_op_cef3ed4ef079aa71171effd3e7308370_destructor);
  return thunk; }
...
PyMODINIT_FUNC initcef3ed4ef079aa71171effd3e7308370(void){
   import_array();
   (void) Py_InitModule("cef3ed4ef079aa71171effd3e7308370", MyMethods);
}
