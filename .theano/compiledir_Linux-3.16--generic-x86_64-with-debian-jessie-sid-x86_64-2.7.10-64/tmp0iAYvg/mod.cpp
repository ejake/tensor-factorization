...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388() {
        ...
        ~__struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388(void) {
            cleanup();
        }
...
npy_int64& V17_i = *V17_iter;
                  ...
                  {
npy_int64 V19_tmp1;
V19_tmp1 = V15_i * V17_i * V7_i;
npy_int64 V19_tmp2;
V19_tmp2 = V11_i * V7_i;
npy_int64 V19_tmp3;
V19_tmp3 = V13_i * V11_i * V7_i;
npy_int8 V19_tmp4;
V19_tmp4 = (V7_i == V9_i);
npy_int64 V19_tmp5;
V19_tmp5 = -V19_tmp1;
...
if (V19_tmp2 < 0) {
    if (V19_tmp3 < 0) {
        V19_tmp6 = ((-V19_tmp2) / (-V19_tmp3));
    } else {
        V19_tmp6 = - ((-V19_tmp2) / V19_tmp3) - ((THEANO_MACRO_MOD((-V19_tmp2), V19_tmp3) == 0) ? 0 : 1);
    }
} else {
    if (V19_tmp3 < 0) {
        V19_tmp6 = - (V19_tmp2 / (-V19_tmp3)) - ((THEANO_MACRO_MOD(V19_tmp2, (-V19_tmp3)) == 0) ? 0 : 1);
...
npy_int64 V19_tmp7;
V19_tmp7 = V19_tmp4 ? V19_tmp6 : V7_i;
npy_int64 V19_tmp8;
V19_tmp8 = V5_i * V19_tmp7;
npy_int64 V19_tmp9;

if (V19_tmp8 < 0) {
    if (V19_tmp5 < 0) {
        V19_tmp9 = ((-V19_tmp8) / (-V19_tmp5));
    } else {
        V19_tmp9 = - ((-V19_tmp8) / V19_tmp5) - ((THEANO_MACRO_MOD((-V19_tmp8), V19_tmp5) == 0) ? 0 : 1);
    }
} else {
    if (V19_tmp5 < 0) {
        V19_tmp9 = - (V19_tmp8 / (-V19_tmp5)) - ((THEANO_MACRO_MOD(V19_tmp8, (-V19_tmp5)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388_executor(__struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388* self) {
            return self->run();
        }

        static void __struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388* struct_ptr = new __struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388_executor), struct_ptr, __struct_compiled_op_8c7e1e3d94fbd11e74ad4d08dd3e4388_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8c7e1e3d94fbd11e74ad4d08dd3e4388(void){
   import_array();
   (void) Py_InitModule("8c7e1e3d94fbd11e74ad4d08dd3e4388", MyMethods);
}
