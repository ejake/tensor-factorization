...
//////////////////////
            ...
            static __global__ void kernel_reduce_ccontig_node_97496c4d3cf9a06dc4082cc141f918d2_0(
        ...
        TODO: find why it don't work or put the GPU compute capability into the version
            ...
            static __global__ void kernel_reduce_1_node_97496c4d3cf9a06dc4082cc141f918d2_0(
                    const unsigned int d0,
    ...
    namespace {
    struct __struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2() {
        ...
        ~__struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2(void) {
            cleanup();
        }
...
if(CudaNdarray_is_c_contiguous(V3)){

        {
          if(CudaNdarray_SIZE(V3)==0){
            ...
            dim3 n_blocks(1);
            if (verbose) printf("running kernel_reduce_ccontig_node_97496c4d3cf9a06dc4082cc141f918d2_0"
                                " n_threads.x=%d, size=%d, ndim=%d\n",
                                n_threads.x,CudaNdarray_SIZE(V3),V3->nd);
            int n_shared = sizeof(float) * n_threads.x;
            kernel_reduce_ccontig_node_97496c4d3cf9a06dc4082cc141f918d2_0<<<n_blocks, n_threads, n_shared>>>(
                    CudaNdarray_SIZE(V3),
            ...
            if (cudaSuccess != sts)
            {
                PyErr_Format(PyExc_RuntimeError,
                    ...
                    "kernel_reduce_ccontig_node_97496c4d3cf9a06dc4082cc141f918d2_0",
...

        {
            ...
            if (verbose)
                printf("running kernel_reduce_1_node_97496c4d3cf9a06dc4082cc141f918d2_0\n");
            ...
            kernel_reduce_1_node_97496c4d3cf9a06dc4082cc141f918d2_0<<<n_blocks, n_threads, n_shared>>>(
            ...
            if (cudaSuccess != sts)
            {
                PyErr_Format(PyExc_RuntimeError,
                    ...
                    " (grid: %i x %i; block: %i x %i x %i)"
                    " shape=(%d) \n",
                    "kernel_reduce_1_node_97496c4d3cf9a06dc4082cc141f918d2_0",
                    cudaGetErrorString(sts),
                    n_blocks.x,
                    n_blocks.y,
                    n_threads.x,
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2_executor(__struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2* self) {
            return self->run();
        }

        static void __struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2* struct_ptr = new __struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2_executor), struct_ptr, __struct_compiled_op_97496c4d3cf9a06dc4082cc141f918d2_destructor);
  return thunk; }
...
PyMODINIT_FUNC init97496c4d3cf9a06dc4082cc141f918d2(void){
   (void) Py_InitModule("97496c4d3cf9a06dc4082cc141f918d2", MyMethods);
}
