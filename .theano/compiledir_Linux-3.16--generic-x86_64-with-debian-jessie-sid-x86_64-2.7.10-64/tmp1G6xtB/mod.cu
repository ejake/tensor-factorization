...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_05d17261ef089a694599cff66aa98d5f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_05d17261ef089a694599cff66aa98d5f() {
        ...
        ~__struct_compiled_op_05d17261ef089a694599cff66aa98d5f(void) {
            cleanup();
        }
...
// Op class GpuGemm
        ...
        #define REAL float
        float node_05d17261ef089a694599cff66aa98d5f_0_a = (PyArray_TYPE(V5) == NPY_FLOAT)
        ? (REAL)(((float*)PyArray_DATA(V5))[0])
        : (REAL)(((double*)PyArray_DATA(V5))[0]);

        float node_05d17261ef089a694599cff66aa98d5f_0_b = (PyArray_TYPE(V5) == NPY_FLOAT) ?
        (REAL)(((float*)PyArray_DATA(V5))[0])
        : (REAL)(((double*)PyArray_DATA(V5))[0]);
        #undef REAL
        ...
        if (0
            ...
            && (CudaNdarray_HOST_STRIDES(V3)[1] >= 0)
            && ((CudaNdarray_HOST_DIMS(V3)[0] <= 1)
                || (CudaNdarray_HOST_STRIDES(V3)[0] == 1)
                    ...
                    || (CudaNdarray_HOST_STRIDES(V1)[1] == 1)))
        {
            ...
            if (CudaNdarray_CopyFromCudaNdarray(V1, V3))
            {
                {
        __failure = 11;
        if (!PyErr_Occurred()) {
        ...
        if (CudaNdarray_gemm(node_05d17261ef089a694599cff66aa98d5f_0_a, V7, V9, node_05d17261ef089a694599cff66aa98d5f_0_b, V1))
        {
            {
        __failure = 11;
        if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_05d17261ef089a694599cff66aa98d5f_executor(__struct_compiled_op_05d17261ef089a694599cff66aa98d5f* self) {
            return self->run();
        }

        static void __struct_compiled_op_05d17261ef089a694599cff66aa98d5f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_05d17261ef089a694599cff66aa98d5f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_05d17261ef089a694599cff66aa98d5f* struct_ptr = new __struct_compiled_op_05d17261ef089a694599cff66aa98d5f();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_05d17261ef089a694599cff66aa98d5f_executor), struct_ptr, __struct_compiled_op_05d17261ef089a694599cff66aa98d5f_destructor);
  return thunk; }
...
PyMODINIT_FUNC init05d17261ef089a694599cff66aa98d5f(void){
   import_array();
   (void) Py_InitModule("05d17261ef089a694599cff66aa98d5f", MyMethods);
}
