...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4() {
        ...
        ~__struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4(void) {
            cleanup();
        }
...
npy_int64& V13_i = *V13_iter;
                  ...
                  {
npy_int64 V15_tmp1;
V15_tmp1 = V7_i * V9_i * V11_i;
npy_int64 V15_tmp2;
V15_tmp2 = V13_i * V7_i * V9_i * V11_i;
npy_int8 V15_tmp3;
V15_tmp3 = (V3_i == V5_i);
npy_int64 V15_tmp4;
...
if (V15_tmp1 < 0) {
    if (V15_tmp2 < 0) {
        V15_tmp4 = ((-V15_tmp1) / (-V15_tmp2));
    } else {
        V15_tmp4 = - ((-V15_tmp1) / V15_tmp2) - ((THEANO_MACRO_MOD((-V15_tmp1), V15_tmp2) == 0) ? 0 : 1);
    }
} else {
    if (V15_tmp2 < 0) {
        V15_tmp4 = - (V15_tmp1 / (-V15_tmp2)) - ((THEANO_MACRO_MOD(V15_tmp1, (-V15_tmp2)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4_executor(__struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4* self) {
            return self->run();
        }

        static void __struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4* struct_ptr = new __struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4_executor), struct_ptr, __struct_compiled_op_30cfd7af482070384a051ad1d30bd8d4_destructor);
  return thunk; }
...
PyMODINIT_FUNC init30cfd7af482070384a051ad1d30bd8d4(void){
   import_array();
   (void) Py_InitModule("30cfd7af482070384a051ad1d30bd8d4", MyMethods);
}
