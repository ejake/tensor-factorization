...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a43c564eba0a16460a718a05555825db {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a43c564eba0a16460a718a05555825db() {
        ...
        ~__struct_compiled_op_a43c564eba0a16460a718a05555825db(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a43c564eba0a16460a718a05555825db_executor(__struct_compiled_op_a43c564eba0a16460a718a05555825db* self) {
            return self->run();
        }

        static void __struct_compiled_op_a43c564eba0a16460a718a05555825db_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a43c564eba0a16460a718a05555825db*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a43c564eba0a16460a718a05555825db* struct_ptr = new __struct_compiled_op_a43c564eba0a16460a718a05555825db();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a43c564eba0a16460a718a05555825db_executor), struct_ptr, __struct_compiled_op_a43c564eba0a16460a718a05555825db_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita43c564eba0a16460a718a05555825db(void){
   import_array();
   (void) Py_InitModule("a43c564eba0a16460a718a05555825db", MyMethods);
}
