...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d() {
        ...
        ~__struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d_executor(__struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d* self) {
            return self->run();
        }

        static void __struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d* struct_ptr = new __struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d_executor), struct_ptr, __struct_compiled_op_4ebd203a5bf38a3e1a866e020e5b875d_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4ebd203a5bf38a3e1a866e020e5b875d(void){
   import_array();
   (void) Py_InitModule("4ebd203a5bf38a3e1a866e020e5b875d", MyMethods);
}
