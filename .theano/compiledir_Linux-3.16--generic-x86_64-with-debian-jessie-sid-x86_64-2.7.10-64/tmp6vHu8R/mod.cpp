...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_f7e26fda6e61e15e586c134fe8914146 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f7e26fda6e61e15e586c134fe8914146() {
        ...
        ~__struct_compiled_op_f7e26fda6e61e15e586c134fe8914146(void) {
            cleanup();
        }
...
V17_0_tmp1 = V7_i - V9_i;
V17_tmp1 = V5_i ? V17_0_tmp1 : V11_i;
}

npy_int64 V17_tmp2;
V17_tmp2 = V17_tmp1 + V9_i;
npy_int64 V17_tmp3;
{
npy_int64 V17_2_tmp1;
V17_2_tmp1 = V17_tmp1 - V13_i;
npy_int64 V17_2_tmp2;
V17_2_tmp2 = V17_2_tmp1 - V9_i;
npy_int64 V17_2_tmp3;

if (V17_2_tmp2 < 0) {
    if (V9_i < 0) {
        V17_2_tmp3 = ((-V17_2_tmp2) / (-V9_i));
    } else {
        V17_2_tmp3 = - ((-V17_2_tmp2) / V9_i) - ((THEANO_MACRO_MOD((-V17_2_tmp2), V9_i) == 0) ? 0 : 1);
    }
} else {
    if (V9_i < 0) {
        V17_2_tmp3 = - (V17_2_tmp2 / (-V9_i)) - ((THEANO_MACRO_MOD(V17_2_tmp2, (-V9_i)) == 0) ? 0 : 1);
...
V17_tmp3 = V17_2_tmp3 + V9_i;
}

npy_int64 V17_tmp4;
{
npy_int8 V17_3_tmp1;
V17_3_tmp1 = (V17_tmp2 < V15_i);
V17_tmp4 = V17_3_tmp1 ? V15_i : V17_tmp2;
}

npy_int64 V17_tmp5;
{
npy_int8 V17_4_tmp1;
V17_4_tmp1 = (V17_tmp3 < V15_i);
npy_int64 V17_4_tmp2;
V17_4_tmp2 = V17_4_tmp1 ? V15_i : V17_tmp3;
npy_int64 V17_4_tmp3;
V17_4_tmp3 = V17_4_tmp2 - V9_i;
npy_int64 V17_4_tmp4;
V17_4_tmp4 = V17_tmp2 - V17_4_tmp3;
V17_tmp5 = V17_4_tmp4 - V9_i;
}

npy_int64 V17_tmp6;
{
npy_int64 V17_5_tmp1;
V17_5_tmp1 = V17_tmp2 - V9_i;
npy_int8 V17_5_tmp2;
V17_5_tmp2 = (V17_tmp5 < V15_i);
V17_tmp6 = V17_5_tmp2 ? V17_5_tmp1 : V17_tmp5;
}

npy_int64 V17_tmp7;
{
npy_int8 V17_6_tmp1;
V17_6_tmp1 = (V17_tmp6 < V15_i);
V17_tmp7 = V17_6_tmp1 ? V15_i : V17_tmp6;
}

npy_int8 V17_tmp8;
V17_tmp8 = (V17_tmp7 < V17_tmp4);
npy_int64 V17_tmp9;
V17_tmp9 = V17_tmp8 ? V17_tmp7 : V17_tmp4;
npy_int64 V17_tmp10;
V17_tmp10 = V3_i - V17_tmp9;
V1_i = V17_tmp10 + V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f7e26fda6e61e15e586c134fe8914146_executor(__struct_compiled_op_f7e26fda6e61e15e586c134fe8914146* self) {
            return self->run();
        }

        static void __struct_compiled_op_f7e26fda6e61e15e586c134fe8914146_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f7e26fda6e61e15e586c134fe8914146*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f7e26fda6e61e15e586c134fe8914146* struct_ptr = new __struct_compiled_op_f7e26fda6e61e15e586c134fe8914146();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f7e26fda6e61e15e586c134fe8914146_executor), struct_ptr, __struct_compiled_op_f7e26fda6e61e15e586c134fe8914146_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf7e26fda6e61e15e586c134fe8914146(void){
   import_array();
   (void) Py_InitModule("f7e26fda6e61e15e586c134fe8914146", MyMethods);
}
