...
static __global__ void kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_1(unsigned int numEls
	, const int dim0
...
npy_float32 o0_i;
        o0_i = ii_i0_value + ii_i1_data[0] + ii_i2_data[0];
ii_o0_data[0] = o0_i;
    }
}
// GpuElemwise{Add}[(0, 2)]
...
//    Input   2 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_2(unsigned int numEls
...
//    Input   2 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, float * o0_data
	)
{
    ...
    for (int i = idx; i < numEls; i += numThreads) {
npy_float32 o0_i;
        o0_i = ii_i0_value + i1_data[i] + i2_data[i];
o0_data[i] = o0_i;
    }
}

        static void can_collapse_node_694b728efe7528d8bc61b2f31b93fc7e_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_694b728efe7528d8bc61b2f31b93fc7e_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_694b728efe7528d8bc61b2f31b93fc7e_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
can_collapse_node_694b728efe7528d8bc61b2f31b93fc7e_0(nd_collapse, local_dims, local_str[2], nd_collapse_2);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_694b728efe7528d8bc61b2f31b93fc7e_0 Add", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_694b728efe7528d8bc61b2f31b93fc7e_0 Add", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_694b728efe7528d8bc61b2f31b93fc7e_0 Add", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Add_node_694b728efe7528d8bc61b2f31b93fc7e_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e() {
        ...
        ~__struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e(void) {
            cleanup();
        }
...
// Op class GpuElemwise
...

        {
            ...
            if (callkernel_node_694b728efe7528d8bc61b2f31b93fc7e_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e_executor(__struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e* self) {
            return self->run();
        }

        static void __struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e* struct_ptr = new __struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e_executor), struct_ptr, __struct_compiled_op_694b728efe7528d8bc61b2f31b93fc7e_destructor);
  return thunk; }
...
PyMODINIT_FUNC init694b728efe7528d8bc61b2f31b93fc7e(void){
   (void) Py_InitModule("694b728efe7528d8bc61b2f31b93fc7e", MyMethods);
}
