...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_5a3b03c2777cf31c52aa38b915db317a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_5a3b03c2777cf31c52aa38b915db317a() {
        ...
        ~__struct_compiled_op_5a3b03c2777cf31c52aa38b915db317a(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_5a3b03c2777cf31c52aa38b915db317a_executor(__struct_compiled_op_5a3b03c2777cf31c52aa38b915db317a* self) {
            return self->run();
        }

        static void __struct_compiled_op_5a3b03c2777cf31c52aa38b915db317a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_5a3b03c2777cf31c52aa38b915db317a*)self);
        }
...
PyMODINIT_FUNC init5a3b03c2777cf31c52aa38b915db317a(void){
   import_array();
   (void) Py_InitModule("5a3b03c2777cf31c52aa38b915db317a", MyMethods);
}
