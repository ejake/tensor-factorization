...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca() {
        ...
        ~__struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca(void) {
            cleanup();
        }
...
// Op class MulSDCSC
            ...
            !(PyArray_ISCONTIGUOUS(V1)))
        {
            ...
            V1 = (PyArrayObject*) PyArray_SimpleNew(1,
                  PyArray_DIMS(V5), PyArray_TYPE(V9));
            if (!V1)
            {
        ...
        { //makes it compile even though labels jump over variable definitions.
            const npy_intp nnz = PyArray_DIMS(V5)[0];
            //TODO: error checking with this
            const npy_intp N =  PyArray_DIMS(V7)[0]-1;

            const dtype_V3 * const __restrict__ data = (dtype_V3*)PyArray_DATA(V3);
            const npy_int32 * const __restrict__ indptr = (npy_int32 *)PyArray_DATA(V7);
            const npy_int32 * const __restrict__ indices = (npy_int32 *)PyArray_DATA(V5);

            dtype_V1 * const __restrict__ zout = (dtype_V1*)PyArray_DATA(V1);

            const npy_intp Sb = PyArray_STRIDES(V9)[0];
            ...
            for (npy_int32 j = 0; j < N; ++j)
            {
                ...
                for (npy_int32 i_idx = indptr[j]; i_idx < indptr[j+1]; ++i_idx)
                {
                    ...
                    const dtype_V9* __restrict__ b_row = (dtype_V9*)(PyArray_BYTES(V9) + Sb * i);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca_executor(__struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca* self) {
            return self->run();
        }

        static void __struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca* struct_ptr = new __struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca_executor), struct_ptr, __struct_compiled_op_47dd81231a585e4c661b609ccb1ce8ca_destructor);
  return thunk; }
...
PyMODINIT_FUNC init47dd81231a585e4c661b609ccb1ce8ca(void){
   import_array();
   (void) Py_InitModule("47dd81231a585e4c661b609ccb1ce8ca", MyMethods);
}
