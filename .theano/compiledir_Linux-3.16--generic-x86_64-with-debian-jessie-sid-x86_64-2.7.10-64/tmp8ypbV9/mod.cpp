...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b82edac79112108c662bece80da54c29 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b82edac79112108c662bece80da54c29() {
        ...
        ~__struct_compiled_op_b82edac79112108c662bece80da54c29(void) {
            cleanup();
        }
...
V17_tmp1 = V9_i - V11_i;
npy_int64 V17_tmp2;
V17_tmp2 = V7_i + V17_tmp1;
npy_int64 V17_tmp3;
V17_tmp3 = ((V13_i)<(V17_tmp2)? (V13_i): ((V17_tmp2)<=(V13_i)? (V17_tmp2): nan("")));
npy_int64 V17_tmp4;
V17_tmp4 = ((V15_i)>(V17_tmp3)? (V15_i): ((V17_tmp3)>=(V15_i)? (V17_tmp3): nan("")));
V1_i = V3_i ? V5_i : V17_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b82edac79112108c662bece80da54c29_executor(__struct_compiled_op_b82edac79112108c662bece80da54c29* self) {
            return self->run();
        }

        static void __struct_compiled_op_b82edac79112108c662bece80da54c29_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b82edac79112108c662bece80da54c29*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b82edac79112108c662bece80da54c29* struct_ptr = new __struct_compiled_op_b82edac79112108c662bece80da54c29();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b82edac79112108c662bece80da54c29_executor), struct_ptr, __struct_compiled_op_b82edac79112108c662bece80da54c29_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb82edac79112108c662bece80da54c29(void){
   import_array();
   (void) Py_InitModule("b82edac79112108c662bece80da54c29", MyMethods);
}
