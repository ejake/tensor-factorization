...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9() {
        ...
        ~__struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9_executor(__struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9* self) {
            return self->run();
        }

        static void __struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9* struct_ptr = new __struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9_executor), struct_ptr, __struct_compiled_op_3b9c8349ed6c312651d583e5aff3dea9_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3b9c8349ed6c312651d583e5aff3dea9(void){
   (void) Py_InitModule("3b9c8349ed6c312651d583e5aff3dea9", MyMethods);
}
