...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef() {
        ...
        ~__struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef_executor(__struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef* self) {
            return self->run();
        }

        static void __struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef* struct_ptr = new __struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef_executor), struct_ptr, __struct_compiled_op_2ce9a82ea298cd98d3edbc88cf1373ef_destructor);
  return thunk; }
...
PyMODINIT_FUNC init2ce9a82ea298cd98d3edbc88cf1373ef(void){
   import_array();
   (void) Py_InitModule("2ce9a82ea298cd98d3edbc88cf1373ef", MyMethods);
}
