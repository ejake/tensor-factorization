...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_1d2d6683408fc558950e135060b1503b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_1d2d6683408fc558950e135060b1503b() {
        ...
        ~__struct_compiled_op_1d2d6683408fc558950e135060b1503b(void) {
            cleanup();
        }
...
npy_float64 V7_tmp1;
V7_tmp1 = V3_i - V5_i;
V1_i = V7_tmp1 < -709.0 ? 0.0 : V7_tmp1 > 19.0 ? 1.0 : 1.0 /(1.0+exp(-V7_tmp1));
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_1d2d6683408fc558950e135060b1503b_executor(__struct_compiled_op_1d2d6683408fc558950e135060b1503b* self) {
            return self->run();
        }

        static void __struct_compiled_op_1d2d6683408fc558950e135060b1503b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_1d2d6683408fc558950e135060b1503b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_1d2d6683408fc558950e135060b1503b* struct_ptr = new __struct_compiled_op_1d2d6683408fc558950e135060b1503b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_1d2d6683408fc558950e135060b1503b_executor), struct_ptr, __struct_compiled_op_1d2d6683408fc558950e135060b1503b_destructor);
  return thunk; }
...
PyMODINIT_FUNC init1d2d6683408fc558950e135060b1503b(void){
   import_array();
   (void) Py_InitModule("1d2d6683408fc558950e135060b1503b", MyMethods);
}
