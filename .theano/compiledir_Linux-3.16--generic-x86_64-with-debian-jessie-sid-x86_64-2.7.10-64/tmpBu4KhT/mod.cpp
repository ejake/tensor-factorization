...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab() {
        ...
        ~__struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab_executor(__struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab* self) {
            return self->run();
        }

        static void __struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab* struct_ptr = new __struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab_executor), struct_ptr, __struct_compiled_op_e5b7a480bb16fca5c0c27dfe099c07ab_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite5b7a480bb16fca5c0c27dfe099c07ab(void){
   import_array();
   (void) Py_InitModule("e5b7a480bb16fca5c0c27dfe099c07ab", MyMethods);
}
