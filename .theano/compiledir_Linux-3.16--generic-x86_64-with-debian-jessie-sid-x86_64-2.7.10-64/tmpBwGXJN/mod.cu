...
#define INTMOD_POW2(a, b) (a & ((1<<b)-1))
        // GpuElemwise{Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))},no_inplace}
// node.op.destroy_map={}
...
//    Input   5 CudaNdarrayType(float32, matrix)
//    Input   6 CudaNdarrayType(float32, row)
//    Input   7 CudaNdarrayType(float32, matrix)
//    Input   8 CudaNdarrayType(float32, row)
//    Input   9 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_1(unsigned int numEls
	, const int dim0
	...
	)
{
    ...
    for (int i = idx; i < numEls; i += numThreads) {
        ...
        const float * ii_i5_data = i5_data;
        const float * ii_i6_data = i6_data;
        ...
        ii_i5_data += pos0 * i5_str_0;
        ii_i6_data += pos0 * i6_str_0;
...
V_DUMMY_ID__tmp1 = ii_i8_data[0] + ii_i9_data[0];
npy_float32 V_DUMMY_ID__tmp2;
V_DUMMY_ID__tmp2 = ii_i0_value + ii_i6_data[0] + ii_i7_data[0];
npy_float32 V_DUMMY_ID__tmp3;
V_DUMMY_ID__tmp3 = ii_i0_value + ii_i1_data[0] + ii_i2_data[0];
npy_float32 V_DUMMY_ID__tmp4;
V_DUMMY_ID__tmp4 = tanh(V_DUMMY_ID__tmp1);
npy_float32 V_DUMMY_ID__tmp5;
V_DUMMY_ID__tmp5 = V_DUMMY_ID__tmp2 < ii_i3_value ? ii_i3_value : V_DUMMY_ID__tmp2 > ii_i4_value ? ii_i4_value : V_DUMMY_ID__tmp2;
npy_float32 V_DUMMY_ID__tmp6;
V_DUMMY_ID__tmp6 = V_DUMMY_ID__tmp3 < ii_i3_value ? ii_i3_value : V_DUMMY_ID__tmp3 > ii_i4_value ? ii_i4_value : V_DUMMY_ID__tmp3;
npy_float32 V_DUMMY_ID__tmp7;
V_DUMMY_ID__tmp7 = V_DUMMY_ID__tmp5 * V_DUMMY_ID__tmp4;
npy_float32 V_DUMMY_ID__tmp8;
V_DUMMY_ID__tmp8 = V_DUMMY_ID__tmp6 * ii_i5_data[0];
o0_i = V_DUMMY_ID__tmp8 + V_DUMMY_ID__tmp7;
}
...
//    Input   9 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_2(unsigned int numEls
	...
	)
{
    ...
    for (int i = idx; i < numEls; i += numThreads) {
        ...
        ii_i5_data += pos1 * i5_str_1;
        ii_i6_data += pos1 * i6_str_1;
...
//    Input   9 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, const float * i3_data
...
npy_float32 o0_i;
        {
npy_float32 V_DUMMY_ID__tmp1;
V_DUMMY_ID__tmp1 = i8_data[i] + i9_data[i];
npy_float32 V_DUMMY_ID__tmp2;
V_DUMMY_ID__tmp2 = ii_i0_value + i6_data[i] + i7_data[i];
npy_float32 V_DUMMY_ID__tmp3;
V_DUMMY_ID__tmp3 = ii_i0_value + i1_data[i] + i2_data[i];
npy_float32 V_DUMMY_ID__tmp4;
V_DUMMY_ID__tmp4 = tanh(V_DUMMY_ID__tmp1);
npy_float32 V_DUMMY_ID__tmp5;
V_DUMMY_ID__tmp5 = V_DUMMY_ID__tmp2 < ii_i3_value ? ii_i3_value : V_DUMMY_ID__tmp2 > ii_i4_value ? ii_i4_value : V_DUMMY_ID__tmp2;
...
V_DUMMY_ID__tmp7 = V_DUMMY_ID__tmp5 * V_DUMMY_ID__tmp4;
npy_float32 V_DUMMY_ID__tmp8;
V_DUMMY_ID__tmp8 = V_DUMMY_ID__tmp6 * i5_data[i];
o0_i = V_DUMMY_ID__tmp8 + V_DUMMY_ID__tmp7;
}
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(int nd, const int * dims, const int * strides, int collapse[])
        {
...
can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(nd_collapse, local_dims, local_str[2], nd_collapse_2);
for(int i=0;i<nd_collapse;i++){
...
nd_collapse_[i]=0;
                        ...
                        int nd_collapse_5[2] = {1,1};

can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(nd_collapse, local_dims, local_str[5], nd_collapse_5);
for(int i=0;i<nd_collapse;i++){
if(nd_collapse_5[i]==0)
nd_collapse_[i]=0;
}
                

                        int nd_collapse_6[2] = {1,1};

can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(nd_collapse, local_dims, local_str[6], nd_collapse_6);
for(int i=0;i<nd_collapse;i++){
if(nd_collapse_6[i]==0)
nd_collapse_[i]=0;
}
...
can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(nd_collapse, local_dims, local_str[7], nd_collapse_7);
for(int i=0;i<nd_collapse;i++){
...
can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(nd_collapse, local_dims, local_str[8], nd_collapse_8);
for(int i=0;i<nd_collapse;i++){
...
can_collapse_node_09929110d833211eeea0dffe9546b6fb_0(nd_collapse, local_dims, local_str[9], nd_collapse_9);
for(int i=0;i<nd_collapse;i++){
...
nd_collapse_[i]=0;
        ...
        if(nd_collapse == 1 
 &&  local_str[1][nd_collapse-1]==1  && local_str[2][nd_collapse-1]==1  && local_str[5][nd_collapse-1]==1  && local_str[6][nd_collapse-1]==1  && local_str[7][nd_collapse-1]==1  && local_str[8][nd_collapse-1]==1  && local_str[9][nd_collapse-1]==1  && local_ostr[0][nd_collapse-1]==1 
){nd_collapse=0;} 
...
case 0: {
                ...
                kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, i3_data, i4_data, i5_data, i6_data, i7_data, i8_data, i9_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_09929110d833211eeea0dffe9546b6fb_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], i4_data, local_str[4][0], i5_data, local_str[5][0], i6_data, local_str[6][0], i7_data, local_str[7][0], i8_data, local_str[8][0], i9_data, local_str[9][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_09929110d833211eeea0dffe9546b6fb_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], i4_data, local_str[4][0], i5_data, local_str[5][0], i6_data, local_str[6][0], i7_data, local_str[7][0], i8_data, local_str[8][0], i9_data, local_str[9][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], i3_data, local_str[3][0], local_str[3][1], i4_data, local_str[4][0], local_str[4][1], i5_data, local_str[5][0], local_str[5][1], i6_data, local_str[6][0], local_str[6][1], i7_data, local_str[7][0], local_str[7][1], i8_data, local_str[8][0], local_str[8][1], i9_data, local_str[9][0], local_str[9][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_09929110d833211eeea0dffe9546b6fb_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_09929110d833211eeea0dffe9546b6fb_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], i3_data, local_str[3][0], local_str[3][1], i4_data, local_str[4][0], local_str[4][1], i5_data, local_str[5][0], local_str[5][1], i6_data, local_str[6][0], local_str[6][1], i7_data, local_str[7][0], local_str[7][1], i8_data, local_str[8][0], local_str[8][1], i9_data, local_str[9][0], local_str[9][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_09929110d833211eeea0dffe9546b6fb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_09929110d833211eeea0dffe9546b6fb() {
        ...
        ~__struct_compiled_op_09929110d833211eeea0dffe9546b6fb(void) {
            cleanup();
        }
...

{
    ...
    {Py_XINCREF(py_V19);}
        ...
        goto __label_20;};
                ...
                if (CudaNdarray_HOST_DIMS(V19)[0] != 1)
                {
                    PyErr_Format(PyExc_RuntimeError,
                                 "c_extract: Some CudaNdarray has dim %i on broadcastable dimension %i",
                                 CudaNdarray_HOST_DIMS(V19)[0], 0);
                    V19 = NULL;
                    {
        __failure = 20;
        if (!PyErr_Occurred()) {
        ...
        goto __label_20;};
                ...
                //std::cerr << "c_extract " << V19 << "dim check 0 passed\n";
                //std::cerr << "c_extract " << V19 << "checking bcast 0 <" << V19->str<< ">\n";
                //std::cerr << "c_extract " << V19->str[0] << "\n";
                if (CudaNdarray_HOST_STRIDES(V19)[0])
                {
                    //std::cerr << "c_extract bad stride detected...\n";
                    PyErr_Format(PyExc_RuntimeError,
                                 "c_extract: Some CudaNdarray has a nonzero stride %i on a broadcastable dimension %i",
                                 CudaNdarray_HOST_STRIDES(V19)[0], 0);
                    V19 = NULL;
                    {
        __failure = 20;
        if (!PyErr_Occurred()) {
        ...
        goto __label_20;};
                ...
                //std::cerr << "c_extract " << V19 << "bcast check 0 passed\n";
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} START\n";
        //standard elemwise size checks
            ...
            int dims[2] = {1,1};
                ...
                int broadcasts_V13[2] = {0, 0};
                

                int broadcasts_V15[2] = {1, 0};
                

                int broadcasts_V17[2] = {0, 0};
                

                int broadcasts_V19[2] = {1, 0};
                

                int broadcasts_V21[2] = {0, 0};
                

        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V3\n";
        if (2 != V3->nd)
        {
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V3 failed\n";
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V5\n";
        if (2 != V5->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V5 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V7\n";
        if (2 != V7->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V7 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V9\n";
        if (2 != V9->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V9 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V11\n";
        if (2 != V11->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V11 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V13\n";
        if (2 != V13->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V13 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V15\n";
        if (2 != V15->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V15 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V17\n";
        if (2 != V17->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V17 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V19\n";
        if (2 != V19->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V19 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V21\n";
        if (2 != V21->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} checking input V21 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
...

        {
            ...
            if (callkernel_node_09929110d833211eeea0dffe9546b6fb_0(1, 0, dims
        ...
        //std::cerr << "C_CODE Composite{((clip((i0 + i1 + i2), i3, i4) * i5) + (clip((i0 + i6 + i7), i3, i4) * tanh((i8 + i9))))} END\n";
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_09929110d833211eeea0dffe9546b6fb_executor(__struct_compiled_op_09929110d833211eeea0dffe9546b6fb* self) {
            return self->run();
        }

        static void __struct_compiled_op_09929110d833211eeea0dffe9546b6fb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_09929110d833211eeea0dffe9546b6fb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_09929110d833211eeea0dffe9546b6fb* struct_ptr = new __struct_compiled_op_09929110d833211eeea0dffe9546b6fb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_09929110d833211eeea0dffe9546b6fb_executor), struct_ptr, __struct_compiled_op_09929110d833211eeea0dffe9546b6fb_destructor);
  return thunk; }
...
PyMODINIT_FUNC init09929110d833211eeea0dffe9546b6fb(void){
   (void) Py_InitModule("09929110d833211eeea0dffe9546b6fb", MyMethods);
}
