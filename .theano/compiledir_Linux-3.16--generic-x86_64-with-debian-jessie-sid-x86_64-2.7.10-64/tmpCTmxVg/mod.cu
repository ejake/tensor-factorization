...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8e7b50a8223127f83423bdce68ed1923 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8e7b50a8223127f83423bdce68ed1923() {
        ...
        ~__struct_compiled_op_8e7b50a8223127f83423bdce68ed1923(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8e7b50a8223127f83423bdce68ed1923_executor(__struct_compiled_op_8e7b50a8223127f83423bdce68ed1923* self) {
            return self->run();
        }

        static void __struct_compiled_op_8e7b50a8223127f83423bdce68ed1923_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8e7b50a8223127f83423bdce68ed1923*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8e7b50a8223127f83423bdce68ed1923* struct_ptr = new __struct_compiled_op_8e7b50a8223127f83423bdce68ed1923();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8e7b50a8223127f83423bdce68ed1923_executor), struct_ptr, __struct_compiled_op_8e7b50a8223127f83423bdce68ed1923_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8e7b50a8223127f83423bdce68ed1923(void){
   (void) Py_InitModule("8e7b50a8223127f83423bdce68ed1923", MyMethods);
}
