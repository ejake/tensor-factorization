...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bf9983b209bce46ff6fed375959bab33 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bf9983b209bce46ff6fed375959bab33() {
        ...
        ~__struct_compiled_op_bf9983b209bce46ff6fed375959bab33(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bf9983b209bce46ff6fed375959bab33_executor(__struct_compiled_op_bf9983b209bce46ff6fed375959bab33* self) {
            return self->run();
        }

        static void __struct_compiled_op_bf9983b209bce46ff6fed375959bab33_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bf9983b209bce46ff6fed375959bab33*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bf9983b209bce46ff6fed375959bab33* struct_ptr = new __struct_compiled_op_bf9983b209bce46ff6fed375959bab33();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bf9983b209bce46ff6fed375959bab33_executor), struct_ptr, __struct_compiled_op_bf9983b209bce46ff6fed375959bab33_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbf9983b209bce46ff6fed375959bab33(void){
   import_array();
   (void) Py_InitModule("bf9983b209bce46ff6fed375959bab33", MyMethods);
}
