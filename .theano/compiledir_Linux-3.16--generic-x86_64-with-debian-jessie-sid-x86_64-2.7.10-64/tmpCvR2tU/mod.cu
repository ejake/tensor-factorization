...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_95124466d92eff5006ecdd397ceefac5 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_95124466d92eff5006ecdd397ceefac5() {
        ...
        ~__struct_compiled_op_95124466d92eff5006ecdd397ceefac5(void) {
            cleanup();
        }
...
// Op class DeepCopyOp
        ...
        int alloc = V1 == NULL;
        for(int i=0; !alloc && i<CudaNdarray_NDIM(V1); i++) {
           if(CudaNdarray_HOST_DIMS(V3)[i] !=
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_95124466d92eff5006ecdd397ceefac5_executor(__struct_compiled_op_95124466d92eff5006ecdd397ceefac5* self) {
            return self->run();
        }

        static void __struct_compiled_op_95124466d92eff5006ecdd397ceefac5_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_95124466d92eff5006ecdd397ceefac5*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_95124466d92eff5006ecdd397ceefac5* struct_ptr = new __struct_compiled_op_95124466d92eff5006ecdd397ceefac5();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_95124466d92eff5006ecdd397ceefac5_executor), struct_ptr, __struct_compiled_op_95124466d92eff5006ecdd397ceefac5_destructor);
  return thunk; }
...
PyMODINIT_FUNC init95124466d92eff5006ecdd397ceefac5(void){
   (void) Py_InitModule("95124466d92eff5006ecdd397ceefac5", MyMethods);
}
