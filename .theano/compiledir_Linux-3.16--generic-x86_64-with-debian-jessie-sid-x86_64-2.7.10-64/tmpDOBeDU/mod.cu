...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_0787a97229bcb74c09ea811a4e75f774 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0787a97229bcb74c09ea811a4e75f774() {
        ...
        ~__struct_compiled_op_0787a97229bcb74c09ea811a4e75f774(void) {
            cleanup();
        }
...
// Op class GpuGemm
        ...
        #define REAL float
        float node_0787a97229bcb74c09ea811a4e75f774_0_a = (PyArray_TYPE(V5) == NPY_FLOAT)
        ? (REAL)(((float*)PyArray_DATA(V5))[0])
        : (REAL)(((double*)PyArray_DATA(V5))[0]);

        float node_0787a97229bcb74c09ea811a4e75f774_0_b = (PyArray_TYPE(V5) == NPY_FLOAT) ?
        (REAL)(((float*)PyArray_DATA(V5))[0])
        : (REAL)(((double*)PyArray_DATA(V5))[0]);
        #undef REAL
        ...
        if (CudaNdarray_gemm(node_0787a97229bcb74c09ea811a4e75f774_0_a, V7, V9, node_0787a97229bcb74c09ea811a4e75f774_0_b, V1))
        {
            {
        __failure = 11;
        if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0787a97229bcb74c09ea811a4e75f774_executor(__struct_compiled_op_0787a97229bcb74c09ea811a4e75f774* self) {
            return self->run();
        }

        static void __struct_compiled_op_0787a97229bcb74c09ea811a4e75f774_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0787a97229bcb74c09ea811a4e75f774*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0787a97229bcb74c09ea811a4e75f774* struct_ptr = new __struct_compiled_op_0787a97229bcb74c09ea811a4e75f774();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0787a97229bcb74c09ea811a4e75f774_executor), struct_ptr, __struct_compiled_op_0787a97229bcb74c09ea811a4e75f774_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0787a97229bcb74c09ea811a4e75f774(void){
   import_array();
   (void) Py_InitModule("0787a97229bcb74c09ea811a4e75f774", MyMethods);
}
