...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_264d1568ec90a7150a9fe9cd50583621 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_264d1568ec90a7150a9fe9cd50583621() {
        ...
        ~__struct_compiled_op_264d1568ec90a7150a9fe9cd50583621(void) {
            cleanup();
        }
...
if (V13_tmp2 < 0) {
    if (V13_tmp3 < 0) {
        V1_i = ((-V13_tmp2) / (-V13_tmp3));
    } else {
        V1_i = - ((-V13_tmp2) / V13_tmp3) - ((THEANO_MACRO_MOD((-V13_tmp2), V13_tmp3) == 0) ? 0 : 1);
    }
} else {
    if (V13_tmp3 < 0) {
        V1_i = - (V13_tmp2 / (-V13_tmp3)) - ((THEANO_MACRO_MOD(V13_tmp2, (-V13_tmp3)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_264d1568ec90a7150a9fe9cd50583621_executor(__struct_compiled_op_264d1568ec90a7150a9fe9cd50583621* self) {
            return self->run();
        }

        static void __struct_compiled_op_264d1568ec90a7150a9fe9cd50583621_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_264d1568ec90a7150a9fe9cd50583621*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_264d1568ec90a7150a9fe9cd50583621* struct_ptr = new __struct_compiled_op_264d1568ec90a7150a9fe9cd50583621();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_264d1568ec90a7150a9fe9cd50583621_executor), struct_ptr, __struct_compiled_op_264d1568ec90a7150a9fe9cd50583621_destructor);
  return thunk; }
...
PyMODINIT_FUNC init264d1568ec90a7150a9fe9cd50583621(void){
   import_array();
   (void) Py_InitModule("264d1568ec90a7150a9fe9cd50583621", MyMethods);
}
