...
#define INTMOD_POW2(a, b) (a & ((1<<b)-1))
        // GpuElemwise{Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))},no_inplace}
// node.op.destroy_map={}
...
static __global__ void kernel_Composite_node_283e0134c9569aadf797d506283b58b8_0_1(unsigned int numEls
	, const int dim0
...
V_DUMMY_ID__tmp1 = tanh(ii_i5_data[0]);
npy_float32 V_DUMMY_ID__tmp2;
V_DUMMY_ID__tmp2 = ii_i0_value + ii_i1_data[0] + ii_i2_data[0];
npy_float32 V_DUMMY_ID__tmp3;
V_DUMMY_ID__tmp3 = V_DUMMY_ID__tmp2 < ii_i3_value ? ii_i3_value : V_DUMMY_ID__tmp2 > ii_i4_value ? ii_i4_value : V_DUMMY_ID__tmp2;
o0_i = V_DUMMY_ID__tmp3 * V_DUMMY_ID__tmp1;
}
...
//    Input   5 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_283e0134c9569aadf797d506283b58b8_0_2(unsigned int numEls
...
//    Input   5 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_283e0134c9569aadf797d506283b58b8_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, const float * i3_data
...
npy_float32 o0_i;
        {
npy_float32 V_DUMMY_ID__tmp1;
V_DUMMY_ID__tmp1 = tanh(i5_data[i]);
npy_float32 V_DUMMY_ID__tmp2;
V_DUMMY_ID__tmp2 = ii_i0_value + i1_data[i] + i2_data[i];
npy_float32 V_DUMMY_ID__tmp3;
V_DUMMY_ID__tmp3 = V_DUMMY_ID__tmp2 < ii_i3_value ? ii_i3_value : V_DUMMY_ID__tmp2 > ii_i4_value ? ii_i4_value : V_DUMMY_ID__tmp2;
o0_i = V_DUMMY_ID__tmp3 * V_DUMMY_ID__tmp1;
}
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_283e0134c9569aadf797d506283b58b8_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_283e0134c9569aadf797d506283b58b8_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_283e0134c9569aadf797d506283b58b8_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
can_collapse_node_283e0134c9569aadf797d506283b58b8_0(nd_collapse, local_dims, local_str[2], nd_collapse_2);
for(int i=0;i<nd_collapse;i++){
...
can_collapse_node_283e0134c9569aadf797d506283b58b8_0(nd_collapse, local_dims, local_str[5], nd_collapse_5);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Composite_node_283e0134c9569aadf797d506283b58b8_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, i3_data, i4_data, i5_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_283e0134c9569aadf797d506283b58b8_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_283e0134c9569aadf797d506283b58b8_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], i4_data, local_str[4][0], i5_data, local_str[5][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_283e0134c9569aadf797d506283b58b8_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_283e0134c9569aadf797d506283b58b8_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], i4_data, local_str[4][0], i5_data, local_str[5][0], o0_data, local_ostr[0][0])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_283e0134c9569aadf797d506283b58b8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_283e0134c9569aadf797d506283b58b8() {
        ...
        ~__struct_compiled_op_283e0134c9569aadf797d506283b58b8(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} START\n";
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V3\n";
        if (2 != V3->nd)
        {
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V3 failed\n";
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V5\n";
        if (2 != V5->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V5 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V7\n";
        if (2 != V7->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V7 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V9\n";
        if (2 != V9->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V9 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V11\n";
        if (2 != V11->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V11 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V13\n";
        if (2 != V13->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} checking input V13 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
...

        {
            ...
            if (callkernel_node_283e0134c9569aadf797d506283b58b8_0(1, 0, dims
        ...
        //std::cerr << "C_CODE Composite{(clip((i0 + i1 + i2), i3, i4) * tanh(i5))} END\n";
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_283e0134c9569aadf797d506283b58b8_executor(__struct_compiled_op_283e0134c9569aadf797d506283b58b8* self) {
            return self->run();
        }

        static void __struct_compiled_op_283e0134c9569aadf797d506283b58b8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_283e0134c9569aadf797d506283b58b8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_283e0134c9569aadf797d506283b58b8* struct_ptr = new __struct_compiled_op_283e0134c9569aadf797d506283b58b8();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_283e0134c9569aadf797d506283b58b8_executor), struct_ptr, __struct_compiled_op_283e0134c9569aadf797d506283b58b8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init283e0134c9569aadf797d506283b58b8(void){
   (void) Py_InitModule("283e0134c9569aadf797d506283b58b8", MyMethods);
}
