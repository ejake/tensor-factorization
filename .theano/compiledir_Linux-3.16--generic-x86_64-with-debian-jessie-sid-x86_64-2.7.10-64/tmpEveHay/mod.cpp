...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063() {
        ...
        ~__struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063_executor(__struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063* self) {
            return self->run();
        }

        static void __struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063* struct_ptr = new __struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063_executor), struct_ptr, __struct_compiled_op_392b66940f99b7ac97b6d5723eb5e063_destructor);
  return thunk; }
...
PyMODINIT_FUNC init392b66940f99b7ac97b6d5723eb5e063(void){
   import_array();
   (void) Py_InitModule("392b66940f99b7ac97b6d5723eb5e063", MyMethods);
}
