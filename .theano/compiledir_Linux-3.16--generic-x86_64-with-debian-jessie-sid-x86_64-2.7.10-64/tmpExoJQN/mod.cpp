...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c() {
        ...
        ~__struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c_executor(__struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c* self) {
            return self->run();
        }

        static void __struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c* struct_ptr = new __struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c_executor), struct_ptr, __struct_compiled_op_64f46e00951ac2114b3df1fc5a67e84c_destructor);
  return thunk; }
...
PyMODINIT_FUNC init64f46e00951ac2114b3df1fc5a67e84c(void){
   import_array();
   (void) Py_InitModule("64f46e00951ac2114b3df1fc5a67e84c", MyMethods);
}
