...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_413178f2c668addd217cf2a314c04513 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_413178f2c668addd217cf2a314c04513() {
        ...
        ~__struct_compiled_op_413178f2c668addd217cf2a314c04513(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_13;}
            ...
            if((PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V11) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V1))){
...
V13_tmp1 = V11_i < -745.0 ? 0.0 : V11_i > 16.0 ? V11_i : log1p(exp(V11_i));
npy_float64 V13_tmp2;
V13_tmp2 = V5_i < -745.0 ? 0.0 : V5_i > 16.0 ? V5_i : log1p(exp(V5_i));
npy_float64 V13_tmp3;
V13_tmp3 = V7_i * V9_i * V13_tmp1;
npy_float64 V13_tmp4;
V13_tmp4 = V3_i * V13_tmp2;
V1_i = V13_tmp4 - V13_tmp3;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_413178f2c668addd217cf2a314c04513_executor(__struct_compiled_op_413178f2c668addd217cf2a314c04513* self) {
            return self->run();
        }

        static void __struct_compiled_op_413178f2c668addd217cf2a314c04513_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_413178f2c668addd217cf2a314c04513*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_413178f2c668addd217cf2a314c04513* struct_ptr = new __struct_compiled_op_413178f2c668addd217cf2a314c04513();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_413178f2c668addd217cf2a314c04513_executor), struct_ptr, __struct_compiled_op_413178f2c668addd217cf2a314c04513_destructor);
  return thunk; }
...
PyMODINIT_FUNC init413178f2c668addd217cf2a314c04513(void){
   import_array();
   (void) Py_InitModule("413178f2c668addd217cf2a314c04513", MyMethods);
}
