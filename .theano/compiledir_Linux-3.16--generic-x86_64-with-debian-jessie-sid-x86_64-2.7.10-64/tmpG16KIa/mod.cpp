...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f() {
        ...
        ~__struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f_executor(__struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f* self) {
            return self->run();
        }

        static void __struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f* struct_ptr = new __struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f_executor), struct_ptr, __struct_compiled_op_add805a6a63f1a2b662212fd1fabbc8f_destructor);
  return thunk; }
...
PyMODINIT_FUNC initadd805a6a63f1a2b662212fd1fabbc8f(void){
   import_array();
   (void) Py_InitModule("add805a6a63f1a2b662212fd1fabbc8f", MyMethods);
}
