...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c0781e82418abbf2cc379bc61e174b64 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c0781e82418abbf2cc379bc61e174b64() {
        ...
        ~__struct_compiled_op_c0781e82418abbf2cc379bc61e174b64(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c0781e82418abbf2cc379bc61e174b64_executor(__struct_compiled_op_c0781e82418abbf2cc379bc61e174b64* self) {
            return self->run();
        }

        static void __struct_compiled_op_c0781e82418abbf2cc379bc61e174b64_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c0781e82418abbf2cc379bc61e174b64*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c0781e82418abbf2cc379bc61e174b64* struct_ptr = new __struct_compiled_op_c0781e82418abbf2cc379bc61e174b64();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c0781e82418abbf2cc379bc61e174b64_executor), struct_ptr, __struct_compiled_op_c0781e82418abbf2cc379bc61e174b64_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc0781e82418abbf2cc379bc61e174b64(void){
   import_array();
   (void) Py_InitModule("c0781e82418abbf2cc379bc61e174b64", MyMethods);
}
