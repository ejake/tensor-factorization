...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_a12fff651421a7a97b7089f9d793328a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a12fff651421a7a97b7089f9d793328a() {
        ...
        ~__struct_compiled_op_a12fff651421a7a97b7089f9d793328a(void) {
            cleanup();
        }
...
if (V11_tmp1 < 0) {
    if (V11_tmp2 < 0) {
        V11_tmp4 = ((-V11_tmp1) / (-V11_tmp2));
    } else {
        V11_tmp4 = - ((-V11_tmp1) / V11_tmp2) - ((THEANO_MACRO_MOD((-V11_tmp1), V11_tmp2) == 0) ? 0 : 1);
    }
} else {
    if (V11_tmp2 < 0) {
        V11_tmp4 = - (V11_tmp1 / (-V11_tmp2)) - ((THEANO_MACRO_MOD(V11_tmp1, (-V11_tmp2)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a12fff651421a7a97b7089f9d793328a_executor(__struct_compiled_op_a12fff651421a7a97b7089f9d793328a* self) {
            return self->run();
        }

        static void __struct_compiled_op_a12fff651421a7a97b7089f9d793328a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a12fff651421a7a97b7089f9d793328a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a12fff651421a7a97b7089f9d793328a* struct_ptr = new __struct_compiled_op_a12fff651421a7a97b7089f9d793328a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a12fff651421a7a97b7089f9d793328a_executor), struct_ptr, __struct_compiled_op_a12fff651421a7a97b7089f9d793328a_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita12fff651421a7a97b7089f9d793328a(void){
   import_array();
   (void) Py_InitModule("a12fff651421a7a97b7089f9d793328a", MyMethods);
}
