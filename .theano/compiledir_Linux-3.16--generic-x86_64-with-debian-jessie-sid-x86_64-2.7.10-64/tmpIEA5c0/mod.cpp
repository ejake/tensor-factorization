...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256() {
        ...
        ~__struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256(void) {
            cleanup();
        }
...
if (V15_tmp2 < 0) {
    if (V15_tmp1 < 0) {
        V15_tmp4 = ((-V15_tmp2) / (-V15_tmp1));
    } else {
        V15_tmp4 = - ((-V15_tmp2) / V15_tmp1) - ((THEANO_MACRO_MOD((-V15_tmp2), V15_tmp1) == 0) ? 0 : 1);
    }
} else {
    if (V15_tmp1 < 0) {
        V15_tmp4 = - (V15_tmp2 / (-V15_tmp1)) - ((THEANO_MACRO_MOD(V15_tmp2, (-V15_tmp1)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256_executor(__struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256* self) {
            return self->run();
        }

        static void __struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256* struct_ptr = new __struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256_executor), struct_ptr, __struct_compiled_op_3c7f5558cdd64e9ae2a3600b1c63d256_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3c7f5558cdd64e9ae2a3600b1c63d256(void){
   import_array();
   (void) Py_InitModule("3c7f5558cdd64e9ae2a3600b1c63d256", MyMethods);
}
