...
static __global__ void kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_1(unsigned int numEls
	, const int dim0
...
//    Input   1 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_2(unsigned int numEls
...
//    Input   1 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, float * o0_data
	)
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_a1179321c49cf1799c713be473e36253_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_a1179321c49cf1799c713be473e36253_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_a1179321c49cf1799c713be473e36253_0(nd_collapse, local_dims, local_str[0], nd_collapse_0);
...
can_collapse_node_a1179321c49cf1799c713be473e36253_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_a1179321c49cf1799c713be473e36253_0 Mul", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_a1179321c49cf1799c713be473e36253_0 Mul", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_a1179321c49cf1799c713be473e36253_0 Mul", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Mul_node_a1179321c49cf1799c713be473e36253_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_a1179321c49cf1799c713be473e36253 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a1179321c49cf1799c713be473e36253() {
        ...
        ~__struct_compiled_op_a1179321c49cf1799c713be473e36253(void) {
            cleanup();
        }
...
// Op class GpuElemwise
...

        {
            ...
            if (callkernel_node_a1179321c49cf1799c713be473e36253_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a1179321c49cf1799c713be473e36253_executor(__struct_compiled_op_a1179321c49cf1799c713be473e36253* self) {
            return self->run();
        }

        static void __struct_compiled_op_a1179321c49cf1799c713be473e36253_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a1179321c49cf1799c713be473e36253*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a1179321c49cf1799c713be473e36253* struct_ptr = new __struct_compiled_op_a1179321c49cf1799c713be473e36253();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a1179321c49cf1799c713be473e36253_executor), struct_ptr, __struct_compiled_op_a1179321c49cf1799c713be473e36253_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita1179321c49cf1799c713be473e36253(void){
   (void) Py_InitModule("a1179321c49cf1799c713be473e36253", MyMethods);
}
