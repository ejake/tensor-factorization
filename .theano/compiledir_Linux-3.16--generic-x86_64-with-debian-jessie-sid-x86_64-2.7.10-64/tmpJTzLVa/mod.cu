...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85() {
        ...
        ~__struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85(void) {
            cleanup();
        }
...
{
// Op class GpuAllocEmpty
int dims[3];
dims[0] = PyInt_AsLong((PyObject*)V3);
dims[1] = PyInt_AsLong((PyObject*)V5);
dims[2] = PyInt_AsLong((PyObject*)V7);
if(V1==NULL
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85_executor(__struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85* self) {
            return self->run();
        }

        static void __struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85* struct_ptr = new __struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85_executor), struct_ptr, __struct_compiled_op_6459ec73e10dabe67e7e9e5ccb026c85_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6459ec73e10dabe67e7e9e5ccb026c85(void){
   import_array();
   (void) Py_InitModule("6459ec73e10dabe67e7e9e5ccb026c85", MyMethods);
}
