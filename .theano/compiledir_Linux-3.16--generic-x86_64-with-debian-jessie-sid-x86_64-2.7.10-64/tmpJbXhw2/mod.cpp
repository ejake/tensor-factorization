...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_812e7778c683ea2025b496adc388c176 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_812e7778c683ea2025b496adc388c176() {
        ...
        ~__struct_compiled_op_812e7778c683ea2025b496adc388c176(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_15;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V13) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V1))){
...
V15_tmp1 = V3_i * V13_i * V9_i;
npy_float64 V15_tmp2;
V15_tmp2 = V7_i - V9_i;
npy_float64 V15_tmp3;
V15_tmp3 = V15_tmp1 / V11_i;
npy_float64 V15_tmp4;
V15_tmp4 = V3_i * V5_i * V15_tmp2;
npy_float64 V15_tmp5;
V15_tmp5 = V15_tmp4 / V11_i;
V1_i = V15_tmp5 - V15_tmp3;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_812e7778c683ea2025b496adc388c176_executor(__struct_compiled_op_812e7778c683ea2025b496adc388c176* self) {
            return self->run();
        }

        static void __struct_compiled_op_812e7778c683ea2025b496adc388c176_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_812e7778c683ea2025b496adc388c176*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_812e7778c683ea2025b496adc388c176* struct_ptr = new __struct_compiled_op_812e7778c683ea2025b496adc388c176();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_812e7778c683ea2025b496adc388c176_executor), struct_ptr, __struct_compiled_op_812e7778c683ea2025b496adc388c176_destructor);
  return thunk; }
...
PyMODINIT_FUNC init812e7778c683ea2025b496adc388c176(void){
   import_array();
   (void) Py_InitModule("812e7778c683ea2025b496adc388c176", MyMethods);
}
