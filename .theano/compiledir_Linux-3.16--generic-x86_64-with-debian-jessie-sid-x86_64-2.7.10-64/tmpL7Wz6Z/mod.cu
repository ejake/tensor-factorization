...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7() {
        ...
        ~__struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7_executor(__struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7* self) {
            return self->run();
        }

        static void __struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7* struct_ptr = new __struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7_executor), struct_ptr, __struct_compiled_op_6174b19f8005a60d6a2faaae7ff1c9a7_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6174b19f8005a60d6a2faaae7ff1c9a7(void){
   import_array();
   (void) Py_InitModule("6174b19f8005a60d6a2faaae7ff1c9a7", MyMethods);
}
