...
// node.op.destroy_map={}
//    Input   0 CudaNdarrayType(float32, (True, True, True))
//    Input   1 CudaNdarrayType(float32, 3D)
//    Output  0 CudaNdarrayType(float32, 3D)
static __global__ void kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_1(unsigned int numEls
	, const int dim0
...
V_DUMMY_ID__tmp1 = ii_i1_data[0] * ii_i1_data[0];
o0_i = ii_i0_value - V_DUMMY_ID__tmp1;
}
...
//    Input   1 CudaNdarrayType(float32, 3D)
//    Output  0 CudaNdarrayType(float32, 3D)
static __global__ void kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_2(unsigned int numEls
...
//    Input   1 CudaNdarrayType(float32, 3D)
//    Output  0 CudaNdarrayType(float32, 3D)
static __global__ void kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_3(unsigned int numEls
	, const int dim0, const int dim1, const int dim2
	, const float * i0_data, int i0_str_0, int i0_str_1, int i0_str_2
	, const float * i1_data, int i1_str_0, int i1_str_1, int i1_str_2
...
//    Input   1 CudaNdarrayType(float32, 3D)
//    Output  0 CudaNdarrayType(float32, 3D)
static __global__ void kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, float * o0_data
	)
...
npy_float32 o0_i;
        {
npy_float32 V_DUMMY_ID__tmp1;
V_DUMMY_ID__tmp1 = i1_data[i] * i1_data[i];
o0_i = ii_i0_value - V_DUMMY_ID__tmp1;
}
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_4cda7be18769c99abdf6e9e44c7d4d7a_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_4cda7be18769c99abdf6e9e44c7d4d7a_0(unsigned int numEls, const int d,
            const int * dims,
...
int nd_collapse_[3] = {1,1,1};
                        ...
                        int nd_collapse_1[3] = {1,1,1};

can_collapse_node_4cda7be18769c99abdf6e9e44c7d4d7a_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
nd_collapse_[i]=0;
        ...
        if(nd_collapse == 1 
 &&  local_str[1][nd_collapse-1]==1  && local_ostr[0][nd_collapse-1]==1 
){nd_collapse=0;} 
...
case 0: {
                ...
                kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_4cda7be18769c99abdf6e9e44c7d4d7a_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_4cda7be18769c99abdf6e9e44c7d4d7a_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_4cda7be18769c99abdf6e9e44c7d4d7a_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
case 3: {
                ...
                kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_3<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], local_dims[2], i0_data, local_str[0][0], local_str[0][1], local_str[0][2], i1_data, local_str[1][0], local_str[1][1], local_str[1][2], o0_data, local_ostr[0][0], local_ostr[0][1], local_ostr[0][2]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_4cda7be18769c99abdf6e9e44c7d4d7a_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_4cda7be18769c99abdf6e9e44c7d4d7a_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], local_dims[2], i0_data, local_str[0][0], local_str[0][1], local_str[0][2], i1_data, local_str[1][0], local_str[1][1], local_str[1][2], o0_data, local_ostr[0][0], local_ostr[0][1], local_ostr[0][2])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a() {
        ...
        ~__struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE Composite{(i0 - sqr(i1))} START\n";
        //standard elemwise size checks
            ...
            int dims[3] = {1,1,1};
                ...
                int broadcasts_V3[3] = {1, 1, 1};
                

                int broadcasts_V5[3] = {0, 0, 0};
                

        //std::cerr << "C_CODE Composite{(i0 - sqr(i1))} checking input V3\n";
        if (3 != V3->nd)
        {
        ...
        for (int i = 0; i< 3; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(i0 - sqr(i1))} checking input V3 failed\n";
        ...
        //std::cerr << "C_CODE Composite{(i0 - sqr(i1))} checking input V5\n";
        if (3 != V5->nd)
        {
            PyErr_Format(PyExc_TypeError,
                         "need 3 dims, not %i", V5->nd);
            {
        __failure = 7;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
        ...
        for (int i = 0; i< 3; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{(i0 - sqr(i1))} checking input V5 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
...

        {
            ...
            if (callkernel_node_4cda7be18769c99abdf6e9e44c7d4d7a_0(1, 0, dims
        ...
        //std::cerr << "C_CODE Composite{(i0 - sqr(i1))} END\n";
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a_executor(__struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a* self) {
            return self->run();
        }

        static void __struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a* struct_ptr = new __struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a_executor), struct_ptr, __struct_compiled_op_4cda7be18769c99abdf6e9e44c7d4d7a_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4cda7be18769c99abdf6e9e44c7d4d7a(void){
   (void) Py_InitModule("4cda7be18769c99abdf6e9e44c7d4d7a", MyMethods);
}
