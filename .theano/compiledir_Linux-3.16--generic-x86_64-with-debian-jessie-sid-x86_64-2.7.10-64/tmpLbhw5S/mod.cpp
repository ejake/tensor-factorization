...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc() {
        ...
        ~__struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc_executor(__struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc* self) {
            return self->run();
        }

        static void __struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc* struct_ptr = new __struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc_executor), struct_ptr, __struct_compiled_op_635d4e280bf914c1e58f6e1b8e8331cc_destructor);
  return thunk; }
...
PyMODINIT_FUNC init635d4e280bf914c1e58f6e1b8e8331cc(void){
   import_array();
   (void) Py_InitModule("635d4e280bf914c1e58f6e1b8e8331cc", MyMethods);
}
