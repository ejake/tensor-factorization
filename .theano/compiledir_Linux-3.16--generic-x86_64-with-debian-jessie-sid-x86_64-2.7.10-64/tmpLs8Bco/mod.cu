...
//////////////////////
            ...
            static __global__ void kernel_reduce_01_node_d549294894e03459b55591663557c9bd_0(
...
)
{
                ...
                if (warpSize != 32)
                {
                    ...
                    for (int i0 = blockIdx.x; i0 < d0; i0 += gridDim.x){
                      ...
                      for (int i1 = threadIdx.x; i1 < d1; i1 += blockDim.x){
                        int i2=0, sA2=0;{
                          int i3=0, sA3=0;{
                            myresult = myresult + A[i3 * sA3 + i2 * sA2 + i1 * sA1 + i0 * sA0];;
                          }
                        }
                      }
    ...
    namespace {
    struct __struct_compiled_op_d549294894e03459b55591663557c9bd {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d549294894e03459b55591663557c9bd() {
        ...
        ~__struct_compiled_op_d549294894e03459b55591663557c9bd(void) {
            cleanup();
        }
...
// Op class GpuCAReduce
 ...
 || (CudaNdarray_HOST_DIMS(V1)[0] != CudaNdarray_HOST_DIMS(V3)[0]) 

           )
        {
            
int new_dims[1]; 
new_dims[0] = CudaNdarray_HOST_DIMS(V3)[0];
...

        {
            ...
            dim3 n_blocks(std::min(CudaNdarray_HOST_DIMS(V3)[0],
                                   NUM_VECTOR_OP_BLOCKS));
            
            if (verbose)
                printf("running kernel_reduce_01_node_d549294894e03459b55591663557c9bd_0\n");
            ...
            kernel_reduce_01_node_d549294894e03459b55591663557c9bd_0<<<n_blocks, n_threads, n_shared>>>(
            ...
            if (cudaSuccess != sts)
            {
                PyErr_Format(PyExc_RuntimeError,
                    ...
                    " shape=(%d,%d) \n",
                    "kernel_reduce_01_node_d549294894e03459b55591663557c9bd_0",
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d549294894e03459b55591663557c9bd_executor(__struct_compiled_op_d549294894e03459b55591663557c9bd* self) {
            return self->run();
        }

        static void __struct_compiled_op_d549294894e03459b55591663557c9bd_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d549294894e03459b55591663557c9bd*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d549294894e03459b55591663557c9bd* struct_ptr = new __struct_compiled_op_d549294894e03459b55591663557c9bd();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d549294894e03459b55591663557c9bd_executor), struct_ptr, __struct_compiled_op_d549294894e03459b55591663557c9bd_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd549294894e03459b55591663557c9bd(void){
   (void) Py_InitModule("d549294894e03459b55591663557c9bd", MyMethods);
}
