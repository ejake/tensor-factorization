...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95() {
        ...
        ~__struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95(void) {
            cleanup();
        }
...
CudaNdarray* xview = NULL;
        ...
        xview = (CudaNdarray*) CudaNdarray_New(1);
        if (!xview)
        {
            {
        __failure = 7;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95_executor(__struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95* self) {
            return self->run();
        }

        static void __struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95* struct_ptr = new __struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95_executor), struct_ptr, __struct_compiled_op_f5c4348de47adf2a6d54a7e6d247bc95_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf5c4348de47adf2a6d54a7e6d247bc95(void){
   import_array();
   (void) Py_InitModule("f5c4348de47adf2a6d54a7e6d247bc95", MyMethods);
}
