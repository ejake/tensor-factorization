...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc() {
        ...
        ~__struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc(void) {
            cleanup();
        }
...
V11_tmp1 = V5_i * V7_i;
npy_int64 V11_tmp2;
V11_tmp2 = V9_i * V5_i * V7_i;
npy_int64 V11_tmp3;

if (V11_tmp1 < 0) {
    if (V11_tmp2 < 0) {
        V11_tmp3 = ((-V11_tmp1) / (-V11_tmp2));
    } else {
        V11_tmp3 = - ((-V11_tmp1) / V11_tmp2) - ((THEANO_MACRO_MOD((-V11_tmp1), V11_tmp2) == 0) ? 0 : 1);
    }
} else {
    if (V11_tmp2 < 0) {
        V11_tmp3 = - (V11_tmp1 / (-V11_tmp2)) - ((THEANO_MACRO_MOD(V11_tmp1, (-V11_tmp2)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc_executor(__struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc* self) {
            return self->run();
        }

        static void __struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc* struct_ptr = new __struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc_executor), struct_ptr, __struct_compiled_op_61ec1bc96a0faeeed7f5a7236e7379dc_destructor);
  return thunk; }
...
PyMODINIT_FUNC init61ec1bc96a0faeeed7f5a7236e7379dc(void){
   import_array();
   (void) Py_InitModule("61ec1bc96a0faeeed7f5a7236e7379dc", MyMethods);
}
