...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a9102e1a42c9b88979f0cf80897daa0c {
        PyObject* __ERROR;

        PyObject* storage_V1;
        

        __struct_compiled_op_a9102e1a42c9b88979f0cf80897daa0c() {
        ...
        ~__struct_compiled_op_a9102e1a42c9b88979f0cf80897daa0c(void) {
            cleanup();
        }
...
// Op class MakeVector
        ...
        npy_intp dims[1];
        dims[0] = 0;
        if(!V1 || PyArray_DIMS(V1)[0] != 0){
            Py_XDECREF(V1);
            V1 = (PyArrayObject*)PyArray_EMPTY(1, dims, 7, 0);
        }
        __label_3:
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a9102e1a42c9b88979f0cf80897daa0c_executor(__struct_compiled_op_a9102e1a42c9b88979f0cf80897daa0c* self) {
            return self->run();
        }

        static void __struct_compiled_op_a9102e1a42c9b88979f0cf80897daa0c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a9102e1a42c9b88979f0cf80897daa0c*)self);
        }
...
PyMODINIT_FUNC inita9102e1a42c9b88979f0cf80897daa0c(void){
   import_array();
   (void) Py_InitModule("a9102e1a42c9b88979f0cf80897daa0c", MyMethods);
}
