...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2() {
        ...
        ~__struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2_executor(__struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2* self) {
            return self->run();
        }

        static void __struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2* struct_ptr = new __struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2_executor), struct_ptr, __struct_compiled_op_b3ccabe64187d46fff86f1797f826bf2_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb3ccabe64187d46fff86f1797f826bf2(void){
   import_array();
   (void) Py_InitModule("b3ccabe64187d46fff86f1797f826bf2", MyMethods);
}
