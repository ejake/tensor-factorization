...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3822e09213127a9018d8f73e171845df {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3822e09213127a9018d8f73e171845df() {
        ...
        ~__struct_compiled_op_3822e09213127a9018d8f73e171845df(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3822e09213127a9018d8f73e171845df_executor(__struct_compiled_op_3822e09213127a9018d8f73e171845df* self) {
            return self->run();
        }

        static void __struct_compiled_op_3822e09213127a9018d8f73e171845df_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3822e09213127a9018d8f73e171845df*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3822e09213127a9018d8f73e171845df* struct_ptr = new __struct_compiled_op_3822e09213127a9018d8f73e171845df();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3822e09213127a9018d8f73e171845df_executor), struct_ptr, __struct_compiled_op_3822e09213127a9018d8f73e171845df_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3822e09213127a9018d8f73e171845df(void){
   import_array();
   (void) Py_InitModule("3822e09213127a9018d8f73e171845df", MyMethods);
}
