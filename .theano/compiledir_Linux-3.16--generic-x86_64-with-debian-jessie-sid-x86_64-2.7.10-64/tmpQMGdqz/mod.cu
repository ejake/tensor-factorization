...
#define INTMOD_POW2(a, b) (a & ((1<<b)-1))
        // GpuElemwise{Composite{((i0 * clip(i1, i2, i3)) + i4)}}[(0, 4)]
// node.op.destroy_map={0: [4]}
...
static __global__ void kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_1(unsigned int numEls
	, const int dim0
...
o0_i = V_DUMMY_ID__tmp2 + ii_i4_data[0];
}
...
//    Input   4 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_2(unsigned int numEls
...
//    Input   4 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, const float * i3_data
...
o0_i = V_DUMMY_ID__tmp2 + i4_data[i];
}
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_92b4cd5041224f8e34985dae82a211ad_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_92b4cd5041224f8e34985dae82a211ad_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_92b4cd5041224f8e34985dae82a211ad_0(nd_collapse, local_dims, local_str[0], nd_collapse_0);
...
can_collapse_node_92b4cd5041224f8e34985dae82a211ad_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
for(int i=0;i<nd_collapse;i++){
...
can_collapse_node_92b4cd5041224f8e34985dae82a211ad_0(nd_collapse, local_dims, local_str[4], nd_collapse_4);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, i3_data, i4_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_92b4cd5041224f8e34985dae82a211ad_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], i4_data, local_str[4][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_92b4cd5041224f8e34985dae82a211ad_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], i4_data, local_str[4][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], i3_data, local_str[3][0], local_str[3][1], i4_data, local_str[4][0], local_str[4][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_92b4cd5041224f8e34985dae82a211ad_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_92b4cd5041224f8e34985dae82a211ad_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], i3_data, local_str[3][0], local_str[3][1], i4_data, local_str[4][0], local_str[4][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_92b4cd5041224f8e34985dae82a211ad {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_92b4cd5041224f8e34985dae82a211ad() {
        ...
        ~__struct_compiled_op_92b4cd5041224f8e34985dae82a211ad(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} START\n";
        ...
        //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V3\n";
        if (2 != V3->nd)
        {
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V3 failed\n";
        ...
        //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V5\n";
        if (2 != V5->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V5 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V7\n";
        if (2 != V7->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V7 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V9\n";
        if (2 != V9->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V9 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V11\n";
        if (2 != V11->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} checking input V11 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
...

        {
            ...
            if (callkernel_node_92b4cd5041224f8e34985dae82a211ad_0(1, 0, dims
        ...
        //std::cerr << "C_CODE Composite{((i0 * clip(i1, i2, i3)) + i4)} END\n";
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_92b4cd5041224f8e34985dae82a211ad_executor(__struct_compiled_op_92b4cd5041224f8e34985dae82a211ad* self) {
            return self->run();
        }

        static void __struct_compiled_op_92b4cd5041224f8e34985dae82a211ad_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_92b4cd5041224f8e34985dae82a211ad*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_92b4cd5041224f8e34985dae82a211ad* struct_ptr = new __struct_compiled_op_92b4cd5041224f8e34985dae82a211ad();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_92b4cd5041224f8e34985dae82a211ad_executor), struct_ptr, __struct_compiled_op_92b4cd5041224f8e34985dae82a211ad_destructor);
  return thunk; }
...
PyMODINIT_FUNC init92b4cd5041224f8e34985dae82a211ad(void){
   (void) Py_InitModule("92b4cd5041224f8e34985dae82a211ad", MyMethods);
}
