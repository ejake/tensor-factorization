...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de() {
        ...
        ~__struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de(void) {
            cleanup();
        }
...
V9_tmp1 = sqrt(V5_i);
npy_float64 V9_tmp2;
V9_tmp2 = ((V7_i)>(V9_tmp1)? (V7_i): ((V9_tmp1)>=(V7_i)? (V9_tmp1): nan("")));
V1_i = V3_i / V9_tmp2;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de_executor(__struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de* self) {
            return self->run();
        }

        static void __struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de* struct_ptr = new __struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de_executor), struct_ptr, __struct_compiled_op_4bfdd3df78ad0a4d9c669327f3b6d7de_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4bfdd3df78ad0a4d9c669327f3b6d7de(void){
   import_array();
   (void) Py_InitModule("4bfdd3df78ad0a4d9c669327f3b6d7de", MyMethods);
}
