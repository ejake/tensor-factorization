...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a332be321c68a95d2e3e1776820ba812 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a332be321c68a95d2e3e1776820ba812() {
        ...
        ~__struct_compiled_op_a332be321c68a95d2e3e1776820ba812(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a332be321c68a95d2e3e1776820ba812_executor(__struct_compiled_op_a332be321c68a95d2e3e1776820ba812* self) {
            return self->run();
        }

        static void __struct_compiled_op_a332be321c68a95d2e3e1776820ba812_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a332be321c68a95d2e3e1776820ba812*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a332be321c68a95d2e3e1776820ba812* struct_ptr = new __struct_compiled_op_a332be321c68a95d2e3e1776820ba812();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a332be321c68a95d2e3e1776820ba812_executor), struct_ptr, __struct_compiled_op_a332be321c68a95d2e3e1776820ba812_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita332be321c68a95d2e3e1776820ba812(void){
   import_array();
   (void) Py_InitModule("a332be321c68a95d2e3e1776820ba812", MyMethods);
}
