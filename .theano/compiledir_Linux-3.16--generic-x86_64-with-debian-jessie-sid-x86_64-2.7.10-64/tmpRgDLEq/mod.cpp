...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_09a37937d19be8d07efcb224304527ca {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_09a37937d19be8d07efcb224304527ca() {
        ...
        ~__struct_compiled_op_09a37937d19be8d07efcb224304527ca(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_9;}
                ...
                V7_stride0 = PyArray_STRIDES(V7)[0] / sizeof(npy_int32);
                ...
                
    {
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(1, dims,
                                                    NPY_INT64,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V7));
        }
        else {
...
V7_iter = (npy_int32*)(PyArray_DATA(V7));
...
npy_int32 &V7_i = * ( V7_iter + ITER_0 * V7_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_09a37937d19be8d07efcb224304527ca_executor(__struct_compiled_op_09a37937d19be8d07efcb224304527ca* self) {
            return self->run();
        }

        static void __struct_compiled_op_09a37937d19be8d07efcb224304527ca_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_09a37937d19be8d07efcb224304527ca*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_09a37937d19be8d07efcb224304527ca* struct_ptr = new __struct_compiled_op_09a37937d19be8d07efcb224304527ca();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_09a37937d19be8d07efcb224304527ca_executor), struct_ptr, __struct_compiled_op_09a37937d19be8d07efcb224304527ca_destructor);
  return thunk; }
...
PyMODINIT_FUNC init09a37937d19be8d07efcb224304527ca(void){
   import_array();
   (void) Py_InitModule("09a37937d19be8d07efcb224304527ca", MyMethods);
}
