...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_97381178e8819860a34f5224c1e2802d {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_97381178e8819860a34f5224c1e2802d() {
        ...
        ~__struct_compiled_op_97381178e8819860a34f5224c1e2802d(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_97381178e8819860a34f5224c1e2802d_executor(__struct_compiled_op_97381178e8819860a34f5224c1e2802d* self) {
            return self->run();
        }

        static void __struct_compiled_op_97381178e8819860a34f5224c1e2802d_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_97381178e8819860a34f5224c1e2802d*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_97381178e8819860a34f5224c1e2802d* struct_ptr = new __struct_compiled_op_97381178e8819860a34f5224c1e2802d();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_97381178e8819860a34f5224c1e2802d_executor), struct_ptr, __struct_compiled_op_97381178e8819860a34f5224c1e2802d_destructor);
  return thunk; }
...
PyMODINIT_FUNC init97381178e8819860a34f5224c1e2802d(void){
   import_array();
   (void) Py_InitModule("97381178e8819860a34f5224c1e2802d", MyMethods);
}
