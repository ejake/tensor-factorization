...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15() {
        ...
        ~__struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15(void) {
            cleanup();
        }
...
V9_tmp3 = -V9_tmp2;
npy_float64 V9_tmp4;
V9_tmp4 = V9_tmp3 < -709.0 ? 0.0 : V9_tmp3 > 19.0 ? 1.0 : 1.0 /(1.0+exp(-V9_tmp3));
V1_i = (V9_tmp4 > V7_i);
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15_executor(__struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15* self) {
            return self->run();
        }

        static void __struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15* struct_ptr = new __struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15_executor), struct_ptr, __struct_compiled_op_3345630e5fb0e7d7e03d41d25f4a6b15_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3345630e5fb0e7d7e03d41d25f4a6b15(void){
   import_array();
   (void) Py_InitModule("3345630e5fb0e7d7e03d41d25f4a6b15", MyMethods);
}
