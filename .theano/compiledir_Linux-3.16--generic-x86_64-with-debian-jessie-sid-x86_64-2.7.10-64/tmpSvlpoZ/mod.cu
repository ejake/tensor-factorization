...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_edba196692e795465f757a4384358e49 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_edba196692e795465f757a4384358e49() {
        ...
        ~__struct_compiled_op_edba196692e795465f757a4384358e49(void) {
            cleanup();
        }
...
CudaNdarray* zview = NULL;
        ...
        zview = (CudaNdarray*) CudaNdarray_New(2);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_edba196692e795465f757a4384358e49_executor(__struct_compiled_op_edba196692e795465f757a4384358e49* self) {
            return self->run();
        }

        static void __struct_compiled_op_edba196692e795465f757a4384358e49_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_edba196692e795465f757a4384358e49*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_edba196692e795465f757a4384358e49* struct_ptr = new __struct_compiled_op_edba196692e795465f757a4384358e49();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_edba196692e795465f757a4384358e49_executor), struct_ptr, __struct_compiled_op_edba196692e795465f757a4384358e49_destructor);
  return thunk; }
...
PyMODINIT_FUNC initedba196692e795465f757a4384358e49(void){
   import_array();
   (void) Py_InitModule("edba196692e795465f757a4384358e49", MyMethods);
}
