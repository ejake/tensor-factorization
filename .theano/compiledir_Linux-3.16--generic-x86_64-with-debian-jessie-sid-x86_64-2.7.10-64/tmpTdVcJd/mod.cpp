...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ec236fa981355142a18008691acbc456 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ec236fa981355142a18008691acbc456() {
        ...
        ~__struct_compiled_op_ec236fa981355142a18008691acbc456(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ec236fa981355142a18008691acbc456_executor(__struct_compiled_op_ec236fa981355142a18008691acbc456* self) {
            return self->run();
        }

        static void __struct_compiled_op_ec236fa981355142a18008691acbc456_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_ec236fa981355142a18008691acbc456*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ec236fa981355142a18008691acbc456* struct_ptr = new __struct_compiled_op_ec236fa981355142a18008691acbc456();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_ec236fa981355142a18008691acbc456_executor), struct_ptr, __struct_compiled_op_ec236fa981355142a18008691acbc456_destructor);
  return thunk; }
...
PyMODINIT_FUNC initec236fa981355142a18008691acbc456(void){
   import_array();
   (void) Py_InitModule("ec236fa981355142a18008691acbc456", MyMethods);
}
