...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c4b269f162dc3712ad33170899c0d75c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c4b269f162dc3712ad33170899c0d75c() {
        ...
        ~__struct_compiled_op_c4b269f162dc3712ad33170899c0d75c(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c4b269f162dc3712ad33170899c0d75c_executor(__struct_compiled_op_c4b269f162dc3712ad33170899c0d75c* self) {
            return self->run();
        }

        static void __struct_compiled_op_c4b269f162dc3712ad33170899c0d75c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c4b269f162dc3712ad33170899c0d75c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c4b269f162dc3712ad33170899c0d75c* struct_ptr = new __struct_compiled_op_c4b269f162dc3712ad33170899c0d75c();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c4b269f162dc3712ad33170899c0d75c_executor), struct_ptr, __struct_compiled_op_c4b269f162dc3712ad33170899c0d75c_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc4b269f162dc3712ad33170899c0d75c(void){
   import_array();
   (void) Py_InitModule("c4b269f162dc3712ad33170899c0d75c", MyMethods);
}
