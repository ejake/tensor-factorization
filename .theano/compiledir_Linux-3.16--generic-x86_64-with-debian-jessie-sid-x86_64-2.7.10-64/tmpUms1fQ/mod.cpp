...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769() {
        ...
        ~__struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769_executor(__struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769* self) {
            return self->run();
        }

        static void __struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769* struct_ptr = new __struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769_executor), struct_ptr, __struct_compiled_op_65f15ef337e12168d0d6f8d7de74f769_destructor);
  return thunk; }
...
PyMODINIT_FUNC init65f15ef337e12168d0d6f8d7de74f769(void){
   import_array();
   (void) Py_InitModule("65f15ef337e12168d0d6f8d7de74f769", MyMethods);
}
