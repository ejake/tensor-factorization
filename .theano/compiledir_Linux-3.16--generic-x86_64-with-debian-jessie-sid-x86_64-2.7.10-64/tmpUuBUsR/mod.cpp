...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bee66a4726c57b6a288573fc7d953c53 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bee66a4726c57b6a288573fc7d953c53() {
        ...
        ~__struct_compiled_op_bee66a4726c57b6a288573fc7d953c53(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bee66a4726c57b6a288573fc7d953c53_executor(__struct_compiled_op_bee66a4726c57b6a288573fc7d953c53* self) {
            return self->run();
        }

        static void __struct_compiled_op_bee66a4726c57b6a288573fc7d953c53_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bee66a4726c57b6a288573fc7d953c53*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bee66a4726c57b6a288573fc7d953c53* struct_ptr = new __struct_compiled_op_bee66a4726c57b6a288573fc7d953c53();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bee66a4726c57b6a288573fc7d953c53_executor), struct_ptr, __struct_compiled_op_bee66a4726c57b6a288573fc7d953c53_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbee66a4726c57b6a288573fc7d953c53(void){
   import_array();
   (void) Py_InitModule("bee66a4726c57b6a288573fc7d953c53", MyMethods);
}
