...
static __global__ void kernel_Composite_node_7a7785233d95e11377dbbaa3365ca50c_0_1(unsigned int numEls
	, const int dim0
...
//    Input   3 CudaNdarrayType(float32, vector)
//    Output  0 CudaNdarrayType(float32, vector)
static __global__ void kernel_Composite_node_7a7785233d95e11377dbbaa3365ca50c_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, const float * i3_data
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_7a7785233d95e11377dbbaa3365ca50c_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_7a7785233d95e11377dbbaa3365ca50c_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_7a7785233d95e11377dbbaa3365ca50c_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
can_collapse_node_7a7785233d95e11377dbbaa3365ca50c_0(nd_collapse, local_dims, local_str[3], nd_collapse_3);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Composite_node_7a7785233d95e11377dbbaa3365ca50c_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, i3_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_7a7785233d95e11377dbbaa3365ca50c_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_7a7785233d95e11377dbbaa3365ca50c_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_7a7785233d95e11377dbbaa3365ca50c_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_7a7785233d95e11377dbbaa3365ca50c_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], o0_data, local_ostr[0][0])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c() {
        ...
        ~__struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c(void) {
            cleanup();
        }
...
// Op class GpuElemwise
...

        {
            ...
            if (callkernel_node_7a7785233d95e11377dbbaa3365ca50c_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c_executor(__struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c* self) {
            return self->run();
        }

        static void __struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c* struct_ptr = new __struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c_executor), struct_ptr, __struct_compiled_op_7a7785233d95e11377dbbaa3365ca50c_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7a7785233d95e11377dbbaa3365ca50c(void){
   (void) Py_InitModule("7a7785233d95e11377dbbaa3365ca50c", MyMethods);
}
