...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29() {
        ...
        ~__struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29(void) {
            cleanup();
        }
...
if (V3_i < 0) {
    if (V5_i < 0) {
        ...
        V1_i = - ((-V3_i) / V5_i) - ((THEANO_MACRO_MOD((-V3_i), V5_i) == 0) ? 0 : 1);
    }
} else {
    if (V5_i < 0) {
        V1_i = - (V3_i / (-V5_i)) - ((THEANO_MACRO_MOD(V3_i, (-V5_i)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29_executor(__struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29* self) {
            return self->run();
        }

        static void __struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29* struct_ptr = new __struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29_executor), struct_ptr, __struct_compiled_op_dfa54a8f047856c4352fb2d7ec07cd29_destructor);
  return thunk; }
...
PyMODINIT_FUNC initdfa54a8f047856c4352fb2d7ec07cd29(void){
   import_array();
   (void) Py_InitModule("dfa54a8f047856c4352fb2d7ec07cd29", MyMethods);
}
