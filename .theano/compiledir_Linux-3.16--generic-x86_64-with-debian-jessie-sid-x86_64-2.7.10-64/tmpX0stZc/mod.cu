...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4() {
        ...
        ~__struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4_executor(__struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4* self) {
            return self->run();
        }

        static void __struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4* struct_ptr = new __struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4_executor), struct_ptr, __struct_compiled_op_6b1a4be5c7d32393600a8de260ffc0e4_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6b1a4be5c7d32393600a8de260ffc0e4(void){
   import_array();
   (void) Py_InitModule("6b1a4be5c7d32393600a8de260ffc0e4", MyMethods);
}
