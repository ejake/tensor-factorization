...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c973066594b89d63734502c5fb3d4c52 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c973066594b89d63734502c5fb3d4c52() {
        ...
        ~__struct_compiled_op_c973066594b89d63734502c5fb3d4c52(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c973066594b89d63734502c5fb3d4c52_executor(__struct_compiled_op_c973066594b89d63734502c5fb3d4c52* self) {
            return self->run();
        }

        static void __struct_compiled_op_c973066594b89d63734502c5fb3d4c52_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c973066594b89d63734502c5fb3d4c52*)self);
        }
...
PyMODINIT_FUNC initc973066594b89d63734502c5fb3d4c52(void){
   import_array();
   (void) Py_InitModule("c973066594b89d63734502c5fb3d4c52", MyMethods);
}
