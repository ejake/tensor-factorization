...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_23bd09edf362672f31013a9d03547767 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_23bd09edf362672f31013a9d03547767() {
        ...
        ~__struct_compiled_op_23bd09edf362672f31013a9d03547767(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_23bd09edf362672f31013a9d03547767_executor(__struct_compiled_op_23bd09edf362672f31013a9d03547767* self) {
            return self->run();
        }

        static void __struct_compiled_op_23bd09edf362672f31013a9d03547767_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_23bd09edf362672f31013a9d03547767*)self);
        }
...
PyMODINIT_FUNC init23bd09edf362672f31013a9d03547767(void){
   import_array();
   (void) Py_InitModule("23bd09edf362672f31013a9d03547767", MyMethods);
}
