...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929() {
        ...
        ~__struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929_executor(__struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929* self) {
            return self->run();
        }

        static void __struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929* struct_ptr = new __struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929_executor), struct_ptr, __struct_compiled_op_dbcfebe28a4c9ad2d5ee262c1789c929_destructor);
  return thunk; }
...
PyMODINIT_FUNC initdbcfebe28a4c9ad2d5ee262c1789c929(void){
   import_array();
   (void) Py_InitModule("dbcfebe28a4c9ad2d5ee262c1789c929", MyMethods);
}
