...
#define INTMOD_POW2(a, b) (a & ((1<<b)-1))
        // GpuElemwise{RoundHalfAwayFromZero}[(0, 0)]
// node.op.destroy_map={0: [0]}
//    Input   0 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_1(unsigned int numEls
	, const int dim0
...
//    Input   0 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_2(unsigned int numEls
...
//    Input   0 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, float * o0_data
	)
{
    ...
    for (int i = idx; i < numEls; i += numThreads) {
npy_float32 o0_i;
        o0_i = round(i0_data[i]);
o0_data[i] = o0_i;
    }
}

        static void can_collapse_node_7f9cb6984c894eb318083c44751a601b_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_7f9cb6984c894eb318083c44751a601b_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_7f9cb6984c894eb318083c44751a601b_0(nd_collapse, local_dims, local_str[0], nd_collapse_0);
...
case 0: {
                ...
                kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_7f9cb6984c894eb318083c44751a601b_0 RoundHalfAwayFromZero", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_7f9cb6984c894eb318083c44751a601b_0 RoundHalfAwayFromZero", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_7f9cb6984c894eb318083c44751a601b_0 RoundHalfAwayFromZero", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_RoundHalfAwayFromZero_node_7f9cb6984c894eb318083c44751a601b_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_7f9cb6984c894eb318083c44751a601b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7f9cb6984c894eb318083c44751a601b() {
        ...
        ~__struct_compiled_op_7f9cb6984c894eb318083c44751a601b(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE RoundHalfAwayFromZero START\n";
        ...
        //std::cerr << "C_CODE RoundHalfAwayFromZero checking input V3\n";
        if (2 != V3->nd)
        {
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE RoundHalfAwayFromZero checking input V3 failed\n";
...

        {
            ...
            if (callkernel_node_7f9cb6984c894eb318083c44751a601b_0(1, 0, dims
        ...
        //std::cerr << "C_CODE RoundHalfAwayFromZero END\n";
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7f9cb6984c894eb318083c44751a601b_executor(__struct_compiled_op_7f9cb6984c894eb318083c44751a601b* self) {
            return self->run();
        }

        static void __struct_compiled_op_7f9cb6984c894eb318083c44751a601b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7f9cb6984c894eb318083c44751a601b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7f9cb6984c894eb318083c44751a601b* struct_ptr = new __struct_compiled_op_7f9cb6984c894eb318083c44751a601b();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7f9cb6984c894eb318083c44751a601b_executor), struct_ptr, __struct_compiled_op_7f9cb6984c894eb318083c44751a601b_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7f9cb6984c894eb318083c44751a601b(void){
   (void) Py_InitModule("7f9cb6984c894eb318083c44751a601b", MyMethods);
}
