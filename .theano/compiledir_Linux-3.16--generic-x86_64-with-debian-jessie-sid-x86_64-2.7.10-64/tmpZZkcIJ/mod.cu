...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3() {
        ...
        ~__struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3_executor(__struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3* self) {
            return self->run();
        }

        static void __struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3* struct_ptr = new __struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3_executor), struct_ptr, __struct_compiled_op_b0020b37592f85d54853b1e7bcced1c3_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb0020b37592f85d54853b1e7bcced1c3(void){
   (void) Py_InitModule("b0020b37592f85d54853b1e7bcced1c3", MyMethods);
}
