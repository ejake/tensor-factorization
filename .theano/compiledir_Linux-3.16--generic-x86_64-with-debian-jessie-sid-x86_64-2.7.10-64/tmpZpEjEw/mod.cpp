...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469() {
        ...
        ~__struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469(void) {
            cleanup();
        }
...
npy_int64& V19_i = *V19_iter;
                  ...
                  {
npy_int64 V21_tmp1;
V21_tmp1 = V7_i * V9_i * V19_i;
npy_int64 V21_tmp2;
V21_tmp2 = V17_i * V19_i;
npy_int64 V21_tmp3;
V21_tmp3 = V13_i * V17_i * V19_i;
npy_int64 V21_tmp4;
V21_tmp4 = V13_i * V7_i * V9_i * V11_i;
npy_int64 V21_tmp5;
V21_tmp5 = V7_i * V9_i * V11_i;
npy_int8 V21_tmp6;
V21_tmp6 = (V3_i == V5_i);
npy_int64 V21_tmp7;
V21_tmp7 = -V21_tmp1;
...
if (V21_tmp2 < 0) {
    if (V21_tmp3 < 0) {
        V21_tmp8 = ((-V21_tmp2) / (-V21_tmp3));
    } else {
        V21_tmp8 = - ((-V21_tmp2) / V21_tmp3) - ((THEANO_MACRO_MOD((-V21_tmp2), V21_tmp3) == 0) ? 0 : 1);
    }
} else {
    if (V21_tmp3 < 0) {
        V21_tmp8 = - (V21_tmp2 / (-V21_tmp3)) - ((THEANO_MACRO_MOD(V21_tmp2, (-V21_tmp3)) == 0) ? 0 : 1);
...
if (V21_tmp5 < 0) {
    if (V21_tmp4 < 0) {
        V21_tmp9 = ((-V21_tmp5) / (-V21_tmp4));
    } else {
        V21_tmp9 = - ((-V21_tmp5) / V21_tmp4) - ((THEANO_MACRO_MOD((-V21_tmp5), V21_tmp4) == 0) ? 0 : 1);
    }
} else {
    if (V21_tmp4 < 0) {
        V21_tmp9 = - (V21_tmp5 / (-V21_tmp4)) - ((THEANO_MACRO_MOD(V21_tmp5, (-V21_tmp4)) == 0) ? 0 : 1);
...
npy_int64 V21_tmp10;
V21_tmp10 = V15_i ? V21_tmp8 : V19_i;
npy_int64 V21_tmp11;
V21_tmp11 = V21_tmp6 ? V21_tmp9 : V3_i;
npy_int64 V21_tmp12;
V21_tmp12 = V21_tmp11 * V21_tmp10;

if (V21_tmp12 < 0) {
    if (V21_tmp7 < 0) {
        V1_i = ((-V21_tmp12) / (-V21_tmp7));
    } else {
        V1_i = - ((-V21_tmp12) / V21_tmp7) - ((THEANO_MACRO_MOD((-V21_tmp12), V21_tmp7) == 0) ? 0 : 1);
    }
} else {
    if (V21_tmp7 < 0) {
        V1_i = - (V21_tmp12 / (-V21_tmp7)) - ((THEANO_MACRO_MOD(V21_tmp12, (-V21_tmp7)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469_executor(__struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469* self) {
            return self->run();
        }

        static void __struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469* struct_ptr = new __struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469_executor), struct_ptr, __struct_compiled_op_27d8ed4deefed2feb06f3730dd4d0469_destructor);
  return thunk; }
...
PyMODINIT_FUNC init27d8ed4deefed2feb06f3730dd4d0469(void){
   import_array();
   (void) Py_InitModule("27d8ed4deefed2feb06f3730dd4d0469", MyMethods);
}
