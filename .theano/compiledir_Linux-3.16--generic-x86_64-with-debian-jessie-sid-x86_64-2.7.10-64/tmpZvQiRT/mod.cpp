...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_8896b493198499a47ddfa60a935009a2 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8896b493198499a47ddfa60a935009a2() {
        ...
        ~__struct_compiled_op_8896b493198499a47ddfa60a935009a2(void) {
            cleanup();
        }
...
V9_tmp1 = V3_i * V5_i;
npy_int64 V9_tmp2;
V9_tmp2 = V7_i * V3_i * V5_i;

if (V9_tmp1 < 0) {
    if (V9_tmp2 < 0) {
        V1_i = ((-V9_tmp1) / (-V9_tmp2));
    } else {
        V1_i = - ((-V9_tmp1) / V9_tmp2) - ((THEANO_MACRO_MOD((-V9_tmp1), V9_tmp2) == 0) ? 0 : 1);
    }
} else {
    if (V9_tmp2 < 0) {
        V1_i = - (V9_tmp1 / (-V9_tmp2)) - ((THEANO_MACRO_MOD(V9_tmp1, (-V9_tmp2)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8896b493198499a47ddfa60a935009a2_executor(__struct_compiled_op_8896b493198499a47ddfa60a935009a2* self) {
            return self->run();
        }

        static void __struct_compiled_op_8896b493198499a47ddfa60a935009a2_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8896b493198499a47ddfa60a935009a2*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8896b493198499a47ddfa60a935009a2* struct_ptr = new __struct_compiled_op_8896b493198499a47ddfa60a935009a2();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8896b493198499a47ddfa60a935009a2_executor), struct_ptr, __struct_compiled_op_8896b493198499a47ddfa60a935009a2_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8896b493198499a47ddfa60a935009a2(void){
   import_array();
   (void) Py_InitModule("8896b493198499a47ddfa60a935009a2", MyMethods);
}
