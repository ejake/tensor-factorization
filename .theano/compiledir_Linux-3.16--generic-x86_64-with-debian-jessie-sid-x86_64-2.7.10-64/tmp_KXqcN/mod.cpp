...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_56c412701112a35a8bb7d4dce6227b39 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_56c412701112a35a8bb7d4dce6227b39() {
        ...
        ~__struct_compiled_op_56c412701112a35a8bb7d4dce6227b39(void) {
            cleanup();
        }
...
// Op class Gemm
        ...
        if ((PyArray_DESCR(V11)->type_num != NPY_DOUBLE)
            && (PyArray_DESCR(V11)->type_num != NPY_FLOAT))
        ...
        */
        ...
        float b = (PyArray_DESCR(V11)->type_num == NPY_FLOAT) ?
        (REAL)(((float*)PyArray_DATA(V11))[0])
        : (REAL)(((double*)PyArray_DATA(V11))[0]);
        #undef REAL
        ...
        ? (REAL)(((float*)PyArray_DATA(V5))[0])
        : (REAL)(((double*)PyArray_DATA(V5))[0]);
        double b = (PyArray_DESCR(V11)->type_num == NPY_FLOAT) ?
        (REAL)(((float*)PyArray_DATA(V11))[0])
        : (REAL)(((double*)PyArray_DATA(V11))[0]);
        #undef REAL
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_56c412701112a35a8bb7d4dce6227b39_executor(__struct_compiled_op_56c412701112a35a8bb7d4dce6227b39* self) {
            return self->run();
        }

        static void __struct_compiled_op_56c412701112a35a8bb7d4dce6227b39_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_56c412701112a35a8bb7d4dce6227b39*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_56c412701112a35a8bb7d4dce6227b39* struct_ptr = new __struct_compiled_op_56c412701112a35a8bb7d4dce6227b39();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_56c412701112a35a8bb7d4dce6227b39_executor), struct_ptr, __struct_compiled_op_56c412701112a35a8bb7d4dce6227b39_destructor);
  return thunk; }
...
PyMODINIT_FUNC init56c412701112a35a8bb7d4dce6227b39(void){
   import_array();
   (void) Py_InitModule("56c412701112a35a8bb7d4dce6227b39", MyMethods);
}
