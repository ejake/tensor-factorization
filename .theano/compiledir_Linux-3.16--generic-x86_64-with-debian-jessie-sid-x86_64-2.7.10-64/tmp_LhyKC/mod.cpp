...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e608033a59c16af70f1c4513490bec3c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e608033a59c16af70f1c4513490bec3c() {
        ...
        ~__struct_compiled_op_e608033a59c16af70f1c4513490bec3c(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e608033a59c16af70f1c4513490bec3c_executor(__struct_compiled_op_e608033a59c16af70f1c4513490bec3c* self) {
            return self->run();
        }

        static void __struct_compiled_op_e608033a59c16af70f1c4513490bec3c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e608033a59c16af70f1c4513490bec3c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e608033a59c16af70f1c4513490bec3c* struct_ptr = new __struct_compiled_op_e608033a59c16af70f1c4513490bec3c();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e608033a59c16af70f1c4513490bec3c_executor), struct_ptr, __struct_compiled_op_e608033a59c16af70f1c4513490bec3c_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite608033a59c16af70f1c4513490bec3c(void){
   import_array();
   (void) Py_InitModule("e608033a59c16af70f1c4513490bec3c", MyMethods);
}
