...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17() {
        ...
        ~__struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17_executor(__struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17* self) {
            return self->run();
        }

        static void __struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17* struct_ptr = new __struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17_executor), struct_ptr, __struct_compiled_op_4b4ddf2617f423020a0bffb041f89e17_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4b4ddf2617f423020a0bffb041f89e17(void){
   (void) Py_InitModule("4b4ddf2617f423020a0bffb041f89e17", MyMethods);
}
