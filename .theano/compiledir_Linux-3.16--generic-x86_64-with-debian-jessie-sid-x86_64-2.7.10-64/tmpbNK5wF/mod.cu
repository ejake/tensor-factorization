...
static __global__ void kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_1(unsigned int numEls
	, const int dim0
...
npy_float32 o0_i;
        o0_i = ii_i0_data[0] < ii_i1_value ? ii_i1_value : ii_i0_data[0] > ii_i2_value ? ii_i2_value : ii_i0_data[0];
ii_o0_data[0] = o0_i;
    }
}
// GpuElemwise{clip,no_inplace}
...
//    Input   2 CudaNdarrayType(float32, (True, True))
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_2(unsigned int numEls
...
//    Input   2 CudaNdarrayType(float32, (True, True))
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, float * o0_data
	)
{
    ...
    for (int i = idx; i < numEls; i += numThreads) {
npy_float32 o0_i;
        o0_i = i0_data[i] < ii_i1_value ? ii_i1_value : i0_data[i] > ii_i2_value ? ii_i2_value : i0_data[i];
o0_data[i] = o0_i;
    }
}

        static void can_collapse_node_6dcc150206b1db9c426670c9eb430075_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_6dcc150206b1db9c426670c9eb430075_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_6dcc150206b1db9c426670c9eb430075_0(nd_collapse, local_dims, local_str[0], nd_collapse_0);
...
case 0: {
                ...
                kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_6dcc150206b1db9c426670c9eb430075_0 Clip", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_6dcc150206b1db9c426670c9eb430075_0 Clip", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_6dcc150206b1db9c426670c9eb430075_0 Clip", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Clip_node_6dcc150206b1db9c426670c9eb430075_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_6dcc150206b1db9c426670c9eb430075 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6dcc150206b1db9c426670c9eb430075() {
        ...
        ~__struct_compiled_op_6dcc150206b1db9c426670c9eb430075(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE clip checking input V3\n";
        if (2 != V3->nd)
        {
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE clip checking input V3 failed\n";
        ...
        //std::cerr << "C_CODE clip checking input V5\n";
        if (2 != V5->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE clip checking input V5 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
        ...
        //std::cerr << "C_CODE clip checking input V7\n";
        if (2 != V7->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE clip checking input V7 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
...

        {
            ...
            if (callkernel_node_6dcc150206b1db9c426670c9eb430075_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6dcc150206b1db9c426670c9eb430075_executor(__struct_compiled_op_6dcc150206b1db9c426670c9eb430075* self) {
            return self->run();
        }

        static void __struct_compiled_op_6dcc150206b1db9c426670c9eb430075_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6dcc150206b1db9c426670c9eb430075*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6dcc150206b1db9c426670c9eb430075* struct_ptr = new __struct_compiled_op_6dcc150206b1db9c426670c9eb430075();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6dcc150206b1db9c426670c9eb430075_executor), struct_ptr, __struct_compiled_op_6dcc150206b1db9c426670c9eb430075_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6dcc150206b1db9c426670c9eb430075(void){
   (void) Py_InitModule("6dcc150206b1db9c426670c9eb430075", MyMethods);
}
