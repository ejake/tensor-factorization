...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e() {
        ...
        ~__struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e_executor(__struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e* self) {
            return self->run();
        }

        static void __struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e* struct_ptr = new __struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e_executor), struct_ptr, __struct_compiled_op_d7342f88cc82338178eb4648b2a0e31e_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd7342f88cc82338178eb4648b2a0e31e(void){
   (void) Py_InitModule("d7342f88cc82338178eb4648b2a0e31e", MyMethods);
}
