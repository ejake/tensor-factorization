...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ffebc71bd0de1f66331618d352e81b31 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ffebc71bd0de1f66331618d352e81b31() {
        ...
        ~__struct_compiled_op_ffebc71bd0de1f66331618d352e81b31(void) {
            cleanup();
        }
...
V21_0_tmp1 = V3_i - V5_i;
V21_tmp1 = V21_0_tmp1 - V7_i;
}

npy_int64 V21_tmp2;
V21_tmp2 = V21_tmp1 + V9_i;
npy_int64 V21_tmp3;
{
npy_int64 V21_2_tmp1;
V21_2_tmp1 = V21_tmp1 + V9_i + V13_i + V15_i;
npy_int8 V21_2_tmp2;
V21_2_tmp2 = (V21_tmp2 < V11_i);
V21_tmp3 = V21_2_tmp2 ? V21_2_tmp1 : V21_tmp2;
}

npy_int64 V21_tmp4;
{
npy_int8 V21_3_tmp1;
V21_3_tmp1 = (V21_tmp3 < V11_i);
V21_tmp4 = V21_3_tmp1 ? V17_i : V21_tmp3;
}

npy_int64 V21_tmp5;
{
npy_int8 V21_4_tmp1;
V21_4_tmp1 = (V21_tmp4 >= V19_i);
V21_tmp5 = V21_4_tmp1 ? V19_i : V21_tmp4;
}

npy_int8 V21_tmp6;
V21_tmp6 = (V21_tmp5 < V11_i);
V1_i = V21_tmp6 ? V11_i : V21_tmp5;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ffebc71bd0de1f66331618d352e81b31_executor(__struct_compiled_op_ffebc71bd0de1f66331618d352e81b31* self) {
            return self->run();
        }

        static void __struct_compiled_op_ffebc71bd0de1f66331618d352e81b31_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_ffebc71bd0de1f66331618d352e81b31*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ffebc71bd0de1f66331618d352e81b31* struct_ptr = new __struct_compiled_op_ffebc71bd0de1f66331618d352e81b31();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_ffebc71bd0de1f66331618d352e81b31_executor), struct_ptr, __struct_compiled_op_ffebc71bd0de1f66331618d352e81b31_destructor);
  return thunk; }
...
PyMODINIT_FUNC initffebc71bd0de1f66331618d352e81b31(void){
   import_array();
   (void) Py_InitModule("ffebc71bd0de1f66331618d352e81b31", MyMethods);
}
