...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07() {
        ...
        ~__struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07(void) {
            cleanup();
        }
...
// Op class GpuDimShuffle
        ...
        goto __label_5;};
            ...
            {
                V1 = (CudaNdarray*) CudaNdarray_New(1);
                if (NULL == V1)
                {
                    {
        __failure = 5;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07_executor(__struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07* self) {
            return self->run();
        }

        static void __struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07* struct_ptr = new __struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07_executor), struct_ptr, __struct_compiled_op_8dbb9aa346da1b094a0d4f32ac022d07_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8dbb9aa346da1b094a0d4f32ac022d07(void){
   (void) Py_InitModule("8dbb9aa346da1b094a0d4f32ac022d07", MyMethods);
}
