...
static __global__ void kernel_Mul_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0_1(unsigned int numEls
	, const int dim0
...
npy_float32 o0_i;
        o0_i = ii_i0_value * ii_i1_data[0] * ii_i2_data[0] * ii_i3_data[0];
ii_o0_data[0] = o0_i;
    }
}
// GpuElemwise{Mul}[(0, 1)]
...
//    Input   3 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Mul_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0_2(unsigned int numEls
...
//    Input   3 CudaNdarrayType(float32, matrix)
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Mul_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, const float * i3_data
	...
	)
{
    ...
    for (int i = idx; i < numEls; i += numThreads) {
npy_float32 o0_i;
        o0_i = ii_i0_value * i1_data[i] * i2_data[i] * i3_data[i];
o0_data[i] = o0_i;
    }
}

        static void can_collapse_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
can_collapse_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0(nd_collapse, local_dims, local_str[2], nd_collapse_2);
for(int i=0;i<nd_collapse;i++){
...
can_collapse_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0(nd_collapse, local_dims, local_str[3], nd_collapse_3);
for(int i=0;i<nd_collapse;i++){
...
nd_collapse_[i]=0;
        ...
        if(nd_collapse == 1 
 &&  local_str[1][nd_collapse-1]==1  && local_str[2][nd_collapse-1]==1  && local_str[3][nd_collapse-1]==1  && local_ostr[0][nd_collapse-1]==1 
){nd_collapse=0;} 
...
case 0: {
                ...
                kernel_Mul_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, i3_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_a6c816eba9a8d2dc1e4389ccc1f6a757_0 Mul", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Mul_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_a6c816eba9a8d2dc1e4389ccc1f6a757_0 Mul", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Mul_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Mul_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], i3_data, local_str[3][0], local_str[3][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757() {
        ...
        ~__struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE Mul checking input V9\n";
        if (2 != V9->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 2; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE Mul checking input V9 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
...

        {
            ...
            if (callkernel_node_a6c816eba9a8d2dc1e4389ccc1f6a757_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757_executor(__struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757* self) {
            return self->run();
        }

        static void __struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757* struct_ptr = new __struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757_executor), struct_ptr, __struct_compiled_op_a6c816eba9a8d2dc1e4389ccc1f6a757_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita6c816eba9a8d2dc1e4389ccc1f6a757(void){
   (void) Py_InitModule("a6c816eba9a8d2dc1e4389ccc1f6a757", MyMethods);
}
