...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a() {
        ...
        ~__struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a_executor(__struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a* self) {
            return self->run();
        }

        static void __struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a* struct_ptr = new __struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a_executor), struct_ptr, __struct_compiled_op_c79dbb77c6174b0566c8f02ec1fee54a_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc79dbb77c6174b0566c8f02ec1fee54a(void){
   import_array();
   (void) Py_InitModule("c79dbb77c6174b0566c8f02ec1fee54a", MyMethods);
}
