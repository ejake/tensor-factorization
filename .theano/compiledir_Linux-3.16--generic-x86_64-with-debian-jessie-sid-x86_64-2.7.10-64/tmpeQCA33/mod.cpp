...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_373d50f8413a0660cec363686c3d5f6f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_373d50f8413a0660cec363686c3d5f6f() {
        ...
        ~__struct_compiled_op_373d50f8413a0660cec363686c3d5f6f(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_373d50f8413a0660cec363686c3d5f6f_executor(__struct_compiled_op_373d50f8413a0660cec363686c3d5f6f* self) {
            return self->run();
        }

        static void __struct_compiled_op_373d50f8413a0660cec363686c3d5f6f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_373d50f8413a0660cec363686c3d5f6f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_373d50f8413a0660cec363686c3d5f6f* struct_ptr = new __struct_compiled_op_373d50f8413a0660cec363686c3d5f6f();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_373d50f8413a0660cec363686c3d5f6f_executor), struct_ptr, __struct_compiled_op_373d50f8413a0660cec363686c3d5f6f_destructor);
  return thunk; }
...
PyMODINIT_FUNC init373d50f8413a0660cec363686c3d5f6f(void){
   import_array();
   (void) Py_InitModule("373d50f8413a0660cec363686c3d5f6f", MyMethods);
}
