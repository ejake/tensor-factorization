...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e() {
        ...
        ~__struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e(void) {
            cleanup();
        }
...
if (V11_tmp2 < 0) {
    if (V11_tmp1 < 0) {
        ...
        V1_i = - ((-V11_tmp2) / V11_tmp1) - ((THEANO_MACRO_MOD((-V11_tmp2), V11_tmp1) == 0) ? 0 : 1);
    }
} else {
    if (V11_tmp1 < 0) {
        V1_i = - (V11_tmp2 / (-V11_tmp1)) - ((THEANO_MACRO_MOD(V11_tmp2, (-V11_tmp1)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e_executor(__struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e* self) {
            return self->run();
        }

        static void __struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e* struct_ptr = new __struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e_executor), struct_ptr, __struct_compiled_op_cb41a796d80c12eb4641d40f507ea52e_destructor);
  return thunk; }
...
PyMODINIT_FUNC initcb41a796d80c12eb4641d40f507ea52e(void){
   import_array();
   (void) Py_InitModule("cb41a796d80c12eb4641d40f507ea52e", MyMethods);
}
