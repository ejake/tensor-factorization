...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb() {
        ...
        ~__struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb(void) {
            cleanup();
        }
...
if (V15_tmp2 < 0) {
    if (V15_tmp3 < 0) {
        V15_tmp4 = ((-V15_tmp2) / (-V15_tmp3));
    } else {
        V15_tmp4 = - ((-V15_tmp2) / V15_tmp3) - ((THEANO_MACRO_MOD((-V15_tmp2), V15_tmp3) == 0) ? 0 : 1);
    }
} else {
    if (V15_tmp3 < 0) {
        V15_tmp4 = - (V15_tmp2 / (-V15_tmp3)) - ((THEANO_MACRO_MOD(V15_tmp2, (-V15_tmp3)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb_executor(__struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb* self) {
            return self->run();
        }

        static void __struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb* struct_ptr = new __struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb_executor), struct_ptr, __struct_compiled_op_0682fc9832d43582a2276a76c1eee3fb_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0682fc9832d43582a2276a76c1eee3fb(void){
   import_array();
   (void) Py_InitModule("0682fc9832d43582a2276a76c1eee3fb", MyMethods);
}
