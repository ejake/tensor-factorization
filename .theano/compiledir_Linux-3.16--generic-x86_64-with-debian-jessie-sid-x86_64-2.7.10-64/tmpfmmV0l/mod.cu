...
static __global__ void kernel_Composite_node_9d930894d7e1cfc18cf78e60c03b46b6_0_1(unsigned int numEls
	, const int dim0
...
//    Input   2 CudaNdarrayType(float32, vector)
//    Output  0 CudaNdarrayType(float32, vector)
static __global__ void kernel_Composite_node_9d930894d7e1cfc18cf78e60c03b46b6_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, float * o0_data
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_9d930894d7e1cfc18cf78e60c03b46b6_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_9d930894d7e1cfc18cf78e60c03b46b6_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_9d930894d7e1cfc18cf78e60c03b46b6_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
can_collapse_node_9d930894d7e1cfc18cf78e60c03b46b6_0(nd_collapse, local_dims, local_str[2], nd_collapse_2);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Composite_node_9d930894d7e1cfc18cf78e60c03b46b6_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_9d930894d7e1cfc18cf78e60c03b46b6_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_9d930894d7e1cfc18cf78e60c03b46b6_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_9d930894d7e1cfc18cf78e60c03b46b6_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_9d930894d7e1cfc18cf78e60c03b46b6_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6() {
        ...
        ~__struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6(void) {
            cleanup();
        }
...
// Op class GpuElemwise
...

        {
            ...
            if (callkernel_node_9d930894d7e1cfc18cf78e60c03b46b6_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6_executor(__struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6* self) {
            return self->run();
        }

        static void __struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6* struct_ptr = new __struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6_executor), struct_ptr, __struct_compiled_op_9d930894d7e1cfc18cf78e60c03b46b6_destructor);
  return thunk; }
...
PyMODINIT_FUNC init9d930894d7e1cfc18cf78e60c03b46b6(void){
   (void) Py_InitModule("9d930894d7e1cfc18cf78e60c03b46b6", MyMethods);
}
