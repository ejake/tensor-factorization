...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52() {
        ...
        ~__struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52_executor(__struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52* self) {
            return self->run();
        }

        static void __struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52* struct_ptr = new __struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52_executor), struct_ptr, __struct_compiled_op_f6a9cff50ceb0c4bab96fe36beafeb52_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf6a9cff50ceb0c4bab96fe36beafeb52(void){
   (void) Py_InitModule("f6a9cff50ceb0c4bab96fe36beafeb52", MyMethods);
}
