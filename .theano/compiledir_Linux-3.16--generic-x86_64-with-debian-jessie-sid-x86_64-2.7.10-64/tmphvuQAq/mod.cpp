...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e26dfb492dd85127ffea80f62b481822 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e26dfb492dd85127ffea80f62b481822() {
        ...
        ~__struct_compiled_op_e26dfb492dd85127ffea80f62b481822(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_5;}
                ...
                V3_stride0 = PyArray_STRIDES(V3)[0] / sizeof(npy_int32);
                ...
                
    {
        ...
        goto __label_5;}
            ...
            dtype_V1& V1_i = V1_ptr[i];
                ...
                {
        V3_iter = (npy_int32*)(PyArray_DATA(V3));
V1_iter = (npy_int64*)(PyArray_DATA(V1));

        for (int ITER_0 = 0; ITER_0<V1_n0; ITER_0++) {
            npy_int32 &V3_i = * ( V3_iter + ITER_0 * V3_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e26dfb492dd85127ffea80f62b481822_executor(__struct_compiled_op_e26dfb492dd85127ffea80f62b481822* self) {
            return self->run();
        }

        static void __struct_compiled_op_e26dfb492dd85127ffea80f62b481822_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e26dfb492dd85127ffea80f62b481822*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e26dfb492dd85127ffea80f62b481822* struct_ptr = new __struct_compiled_op_e26dfb492dd85127ffea80f62b481822();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e26dfb492dd85127ffea80f62b481822_executor), struct_ptr, __struct_compiled_op_e26dfb492dd85127ffea80f62b481822_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite26dfb492dd85127ffea80f62b481822(void){
   import_array();
   (void) Py_InitModule("e26dfb492dd85127ffea80f62b481822", MyMethods);
}
