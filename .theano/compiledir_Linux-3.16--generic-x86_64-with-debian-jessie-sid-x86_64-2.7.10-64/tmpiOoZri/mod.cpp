...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444() {
        ...
        ~__struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_13;}
                ...
                V3_stride1 = PyArray_STRIDES(V3)[1] / sizeof(npy_float64);
        ...
        goto __label_13;}
                ...
                V7_stride1 = PyArray_STRIDES(V7)[1] / sizeof(npy_float64);
        ...
        goto __label_13;}
                ...
                V9_stride1 = PyArray_STRIDES(V9)[1] / sizeof(npy_float64);
        ...
        goto __label_13;}
                ...
                V11_stride1 = PyArray_STRIDES(V11)[1] / sizeof(npy_float64);
        ...
        goto __label_13;}
            ...
            if((PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V11) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V1))){
...
V13_tmp2 = V3_i * V13_tmp1;
V1_i = V13_tmp2 + V9_i + V11_i;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444_executor(__struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444* self) {
            return self->run();
        }

        static void __struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444* struct_ptr = new __struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444_executor), struct_ptr, __struct_compiled_op_1b73df8769e5ab0e2a61d895b3410444_destructor);
  return thunk; }
...
PyMODINIT_FUNC init1b73df8769e5ab0e2a61d895b3410444(void){
   import_array();
   (void) Py_InitModule("1b73df8769e5ab0e2a61d895b3410444", MyMethods);
}
