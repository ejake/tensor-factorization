...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e4ab1a44a39ef5094843710d078518ed {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e4ab1a44a39ef5094843710d078518ed() {
        ...
        ~__struct_compiled_op_e4ab1a44a39ef5094843710d078518ed(void) {
            cleanup();
        }
                ...
                
    {
        ...
        if (!V1) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(1, dims, NPY_INT8, 0);
            }
        }
        if (!V1) {
            {
...
npy_float64 V9_tmp3;
V9_tmp3 = V9_tmp2 < -709.0 ? 0.0 : V9_tmp2 > 19.0 ? 1.0 : 1.0 /(1.0+exp(-V9_tmp2));
V1_i = (V9_tmp3 > V7_i);
}
;
                    }
...
npy_int8 &V1_i = * ( V1_iter + ITER_0 * V1_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e4ab1a44a39ef5094843710d078518ed_executor(__struct_compiled_op_e4ab1a44a39ef5094843710d078518ed* self) {
            return self->run();
        }

        static void __struct_compiled_op_e4ab1a44a39ef5094843710d078518ed_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e4ab1a44a39ef5094843710d078518ed*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e4ab1a44a39ef5094843710d078518ed* struct_ptr = new __struct_compiled_op_e4ab1a44a39ef5094843710d078518ed();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e4ab1a44a39ef5094843710d078518ed_executor), struct_ptr, __struct_compiled_op_e4ab1a44a39ef5094843710d078518ed_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite4ab1a44a39ef5094843710d078518ed(void){
   import_array();
   (void) Py_InitModule("e4ab1a44a39ef5094843710d078518ed", MyMethods);
}
