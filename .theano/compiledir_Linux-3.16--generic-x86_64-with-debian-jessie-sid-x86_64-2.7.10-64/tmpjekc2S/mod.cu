...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e() {
        ...
        ~__struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e(void) {
            cleanup();
        }
...
||CudaNdarray_HOST_DIMS(V1)[0]!=dims[0]||CudaNdarray_HOST_DIMS(V1)[1]!=dims[1]){
        ...
        if (0 && CudaNdarray_is_c_contiguous(V1))
        {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e_executor(__struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e* self) {
            return self->run();
        }

        static void __struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e* struct_ptr = new __struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e_executor), struct_ptr, __struct_compiled_op_7c1921c71e9ca2af0def0420de018d7e_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7c1921c71e9ca2af0def0420de018d7e(void){
   import_array();
   (void) Py_InitModule("7c1921c71e9ca2af0def0420de018d7e", MyMethods);
}
