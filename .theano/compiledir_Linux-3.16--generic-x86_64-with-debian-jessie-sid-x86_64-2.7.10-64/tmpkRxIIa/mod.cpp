...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_41809fb98ad65a1e237323882c8ead32 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_41809fb98ad65a1e237323882c8ead32() {
        ...
        ~__struct_compiled_op_41809fb98ad65a1e237323882c8ead32(void) {
            cleanup();
        }
...
if (V3_i < 0) {
    if (V9_tmp2 < 0) {
        ...
        V1_i = - ((-V3_i) / V9_tmp2) - ((THEANO_MACRO_MOD((-V3_i), V9_tmp2) == 0) ? 0 : 1);
    }
} else {
    if (V9_tmp2 < 0) {
        V1_i = - (V3_i / (-V9_tmp2)) - ((THEANO_MACRO_MOD(V3_i, (-V9_tmp2)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_41809fb98ad65a1e237323882c8ead32_executor(__struct_compiled_op_41809fb98ad65a1e237323882c8ead32* self) {
            return self->run();
        }

        static void __struct_compiled_op_41809fb98ad65a1e237323882c8ead32_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_41809fb98ad65a1e237323882c8ead32*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_41809fb98ad65a1e237323882c8ead32* struct_ptr = new __struct_compiled_op_41809fb98ad65a1e237323882c8ead32();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_41809fb98ad65a1e237323882c8ead32_executor), struct_ptr, __struct_compiled_op_41809fb98ad65a1e237323882c8ead32_destructor);
  return thunk; }
...
PyMODINIT_FUNC init41809fb98ad65a1e237323882c8ead32(void){
   import_array();
   (void) Py_InitModule("41809fb98ad65a1e237323882c8ead32", MyMethods);
}
