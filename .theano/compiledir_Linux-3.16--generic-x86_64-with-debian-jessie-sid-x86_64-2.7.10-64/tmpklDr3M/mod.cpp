...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1() {
        ...
        ~__struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1(void) {
            cleanup();
        }
...
npy_int8& V7_i = *V7_iter;
                  ...
                  {
npy_int64 V9_tmp1;
V9_tmp1 = ((V7_i)>(V5_i)? (V7_i): ((V5_i)>=(V7_i)? (V5_i): nan("")));
V1_i = V3_i + V9_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1_executor(__struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1* self) {
            return self->run();
        }

        static void __struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1* struct_ptr = new __struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1_executor), struct_ptr, __struct_compiled_op_5152d9fce8a7911a3981f2f8db403be1_destructor);
  return thunk; }
...
PyMODINIT_FUNC init5152d9fce8a7911a3981f2f8db403be1(void){
   import_array();
   (void) Py_InitModule("5152d9fce8a7911a3981f2f8db403be1", MyMethods);
}
