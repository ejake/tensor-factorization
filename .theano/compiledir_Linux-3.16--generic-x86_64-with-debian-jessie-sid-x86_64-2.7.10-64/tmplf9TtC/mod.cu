...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bc49d03261b64981e97c19a17561e99c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bc49d03261b64981e97c19a17561e99c() {
        ...
        ~__struct_compiled_op_bc49d03261b64981e97c19a17561e99c(void) {
            cleanup();
        }
...
{
// Op class GpuDot22Scalar

        #define REAL float
        float node_bc49d03261b64981e97c19a17561e99c_0_a = (PyArray_TYPE(V7) == NPY_FLOAT)
        ...
        if (CudaNdarray_gemm(node_bc49d03261b64981e97c19a17561e99c_0_a, V3, V5, 0.0f, V1))
        {
            if (V1)
            {
                Py_DECREF(V1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bc49d03261b64981e97c19a17561e99c_executor(__struct_compiled_op_bc49d03261b64981e97c19a17561e99c* self) {
            return self->run();
        }

        static void __struct_compiled_op_bc49d03261b64981e97c19a17561e99c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bc49d03261b64981e97c19a17561e99c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bc49d03261b64981e97c19a17561e99c* struct_ptr = new __struct_compiled_op_bc49d03261b64981e97c19a17561e99c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bc49d03261b64981e97c19a17561e99c_executor), struct_ptr, __struct_compiled_op_bc49d03261b64981e97c19a17561e99c_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbc49d03261b64981e97c19a17561e99c(void){
   import_array();
   (void) Py_InitModule("bc49d03261b64981e97c19a17561e99c", MyMethods);
}
