...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ac8553f67e9911c9f16203479455a677 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ac8553f67e9911c9f16203479455a677() {
        ...
        ~__struct_compiled_op_ac8553f67e9911c9f16203479455a677(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ac8553f67e9911c9f16203479455a677_executor(__struct_compiled_op_ac8553f67e9911c9f16203479455a677* self) {
            return self->run();
        }

        static void __struct_compiled_op_ac8553f67e9911c9f16203479455a677_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_ac8553f67e9911c9f16203479455a677*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ac8553f67e9911c9f16203479455a677* struct_ptr = new __struct_compiled_op_ac8553f67e9911c9f16203479455a677();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_ac8553f67e9911c9f16203479455a677_executor), struct_ptr, __struct_compiled_op_ac8553f67e9911c9f16203479455a677_destructor);
  return thunk; }
...
PyMODINIT_FUNC initac8553f67e9911c9f16203479455a677(void){
   import_array();
   (void) Py_InitModule("ac8553f67e9911c9f16203479455a677", MyMethods);
}
