...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13() {
        ...
        ~__struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13(void) {
            cleanup();
        }
...
// Op class GpuDimShuffle
        ...
        goto __label_5;};
            ...
            {
                V1 = (CudaNdarray*) CudaNdarray_New(2);
                if (NULL == V1)
                {
                    {
        __failure = 5;
        ...
        CudaNdarray_set_dim(V1, 0, 1);
        CudaNdarray_set_stride(V1, 0, 0);
                

        CudaNdarray_set_dim(V1, 1, 1);
        CudaNdarray_set_stride(V1, 1, 0);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13_executor(__struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13* self) {
            return self->run();
        }

        static void __struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13* struct_ptr = new __struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13_executor), struct_ptr, __struct_compiled_op_a16bc42439b8f6f8784645c1cd3c5d13_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita16bc42439b8f6f8784645c1cd3c5d13(void){
   (void) Py_InitModule("a16bc42439b8f6f8784645c1cd3c5d13", MyMethods);
}
