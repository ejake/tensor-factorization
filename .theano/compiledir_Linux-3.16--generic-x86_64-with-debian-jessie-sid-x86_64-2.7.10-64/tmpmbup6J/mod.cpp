...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bf30a4cdbf645499cb7602837dae5016 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bf30a4cdbf645499cb7602837dae5016() {
        ...
        ~__struct_compiled_op_bf30a4cdbf645499cb7602837dae5016(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_7;}
                ...
                V3_stride1 = PyArray_STRIDES(V3)[1] / sizeof(npy_int64);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bf30a4cdbf645499cb7602837dae5016_executor(__struct_compiled_op_bf30a4cdbf645499cb7602837dae5016* self) {
            return self->run();
        }

        static void __struct_compiled_op_bf30a4cdbf645499cb7602837dae5016_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bf30a4cdbf645499cb7602837dae5016*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bf30a4cdbf645499cb7602837dae5016* struct_ptr = new __struct_compiled_op_bf30a4cdbf645499cb7602837dae5016();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bf30a4cdbf645499cb7602837dae5016_executor), struct_ptr, __struct_compiled_op_bf30a4cdbf645499cb7602837dae5016_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbf30a4cdbf645499cb7602837dae5016(void){
   import_array();
   (void) Py_InitModule("bf30a4cdbf645499cb7602837dae5016", MyMethods);
}
