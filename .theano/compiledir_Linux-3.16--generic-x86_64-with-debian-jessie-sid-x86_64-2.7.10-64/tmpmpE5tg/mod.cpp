...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a() {
        ...
        ~__struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_15;}
                ...
                V13_stride1 = PyArray_STRIDES(V13)[1] / sizeof(npy_float64);
...
dims[1] = V7_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT64,
                                                    PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13));
        }
        else {
        ...
        goto __label_15;}
                ...
                V1_stride1 = PyArray_STRIDES(V1)[1] / sizeof(npy_float64);
...
V15_tmp2 = V3_i * V15_tmp1 * V9_i;
V1_i = V15_tmp2 + V11_i + V13_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a_executor(__struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a* self) {
            return self->run();
        }

        static void __struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a* struct_ptr = new __struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a_executor), struct_ptr, __struct_compiled_op_1868917fc4862118e1f2e8d2afd5144a_destructor);
  return thunk; }
...
PyMODINIT_FUNC init1868917fc4862118e1f2e8d2afd5144a(void){
   import_array();
   (void) Py_InitModule("1868917fc4862118e1f2e8d2afd5144a", MyMethods);
}
