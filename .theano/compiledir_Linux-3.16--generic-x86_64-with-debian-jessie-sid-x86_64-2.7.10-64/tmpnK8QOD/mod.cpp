...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c() {
        ...
        ~__struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c_executor(__struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c* self) {
            return self->run();
        }

        static void __struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c* struct_ptr = new __struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c_executor), struct_ptr, __struct_compiled_op_52f52c86941e6024e88e2e98d46a2d9c_destructor);
  return thunk; }
...
PyMODINIT_FUNC init52f52c86941e6024e88e2e98d46a2d9c(void){
   import_array();
   (void) Py_InitModule("52f52c86941e6024e88e2e98d46a2d9c", MyMethods);
}
