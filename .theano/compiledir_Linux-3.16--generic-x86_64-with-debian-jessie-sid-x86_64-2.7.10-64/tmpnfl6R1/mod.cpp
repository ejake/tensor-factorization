...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1() {
        ...
        ~__struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1_executor(__struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1* self) {
            return self->run();
        }

        static void __struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1* struct_ptr = new __struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1_executor), struct_ptr, __struct_compiled_op_cfd54ab305f518a6ede0dbb79108f6b1_destructor);
  return thunk; }
...
PyMODINIT_FUNC initcfd54ab305f518a6ede0dbb79108f6b1(void){
   import_array();
   (void) Py_InitModule("cfd54ab305f518a6ede0dbb79108f6b1", MyMethods);
}
