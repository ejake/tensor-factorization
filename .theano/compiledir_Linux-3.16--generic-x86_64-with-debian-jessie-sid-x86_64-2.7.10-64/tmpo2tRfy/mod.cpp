...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_c591835a3ef7de5c493bcbe8489683df {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c591835a3ef7de5c493bcbe8489683df() {
        ...
        ~__struct_compiled_op_c591835a3ef7de5c493bcbe8489683df(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c591835a3ef7de5c493bcbe8489683df_executor(__struct_compiled_op_c591835a3ef7de5c493bcbe8489683df* self) {
            return self->run();
        }

        static void __struct_compiled_op_c591835a3ef7de5c493bcbe8489683df_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c591835a3ef7de5c493bcbe8489683df*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c591835a3ef7de5c493bcbe8489683df* struct_ptr = new __struct_compiled_op_c591835a3ef7de5c493bcbe8489683df();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c591835a3ef7de5c493bcbe8489683df_executor), struct_ptr, __struct_compiled_op_c591835a3ef7de5c493bcbe8489683df_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc591835a3ef7de5c493bcbe8489683df(void){
   import_array();
   (void) Py_InitModule("c591835a3ef7de5c493bcbe8489683df", MyMethods);
}
