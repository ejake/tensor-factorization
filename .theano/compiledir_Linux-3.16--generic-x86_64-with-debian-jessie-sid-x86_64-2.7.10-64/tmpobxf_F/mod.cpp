...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_312793bc8ea342bec601464af450df01 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_312793bc8ea342bec601464af450df01() {
        ...
        ~__struct_compiled_op_312793bc8ea342bec601464af450df01(void) {
            cleanup();
        }
...
npy_int64 &V7_i = * ( V7_iter + ITER_0 * V7_jumpx_0 );
npy_int64 &V9_i = * ( V9_iter + ITER_0 * V9_jumpx_0 );
npy_int64 &V11_i = * ( V11_iter + ITER_0 * V11_jumpx_0 );
npy_int64 &V13_i = * ( V13_iter + ITER_0 * V13_jumpx_0 );
...
if (V15_tmp2 < 0) {
    if (V15_tmp4 < 0) {
        V15_tmp5 = ((-V15_tmp2) / (-V15_tmp4));
    } else {
        V15_tmp5 = - ((-V15_tmp2) / V15_tmp4) - ((THEANO_MACRO_MOD((-V15_tmp2), V15_tmp4) == 0) ? 0 : 1);
    }
} else {
    if (V15_tmp4 < 0) {
        V15_tmp5 = - (V15_tmp2 / (-V15_tmp4)) - ((THEANO_MACRO_MOD(V15_tmp2, (-V15_tmp4)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_312793bc8ea342bec601464af450df01_executor(__struct_compiled_op_312793bc8ea342bec601464af450df01* self) {
            return self->run();
        }

        static void __struct_compiled_op_312793bc8ea342bec601464af450df01_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_312793bc8ea342bec601464af450df01*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_312793bc8ea342bec601464af450df01* struct_ptr = new __struct_compiled_op_312793bc8ea342bec601464af450df01();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_312793bc8ea342bec601464af450df01_executor), struct_ptr, __struct_compiled_op_312793bc8ea342bec601464af450df01_destructor);
  return thunk; }
...
PyMODINIT_FUNC init312793bc8ea342bec601464af450df01(void){
   import_array();
   (void) Py_InitModule("312793bc8ea342bec601464af450df01", MyMethods);
}
