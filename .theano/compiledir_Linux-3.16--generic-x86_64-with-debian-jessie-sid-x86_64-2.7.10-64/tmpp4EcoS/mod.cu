...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873() {
        ...
        ~__struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873_executor(__struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873* self) {
            return self->run();
        }

        static void __struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873* struct_ptr = new __struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873_executor), struct_ptr, __struct_compiled_op_fc0a77fd0d7a0a0c610947f403047873_destructor);
  return thunk; }
...
PyMODINIT_FUNC initfc0a77fd0d7a0a0c610947f403047873(void){
   (void) Py_InitModule("fc0a77fd0d7a0a0c610947f403047873", MyMethods);
}
