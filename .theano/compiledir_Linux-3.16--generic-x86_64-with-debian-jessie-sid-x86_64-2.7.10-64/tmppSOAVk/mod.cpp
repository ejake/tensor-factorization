...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad() {
        ...
        ~__struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad_executor(__struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad* self) {
            return self->run();
        }

        static void __struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad* struct_ptr = new __struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad_executor), struct_ptr, __struct_compiled_op_17bb793a5efeb5f5891e50a2e8daccad_destructor);
  return thunk; }
...
PyMODINIT_FUNC init17bb793a5efeb5f5891e50a2e8daccad(void){
   import_array();
   (void) Py_InitModule("17bb793a5efeb5f5891e50a2e8daccad", MyMethods);
}
