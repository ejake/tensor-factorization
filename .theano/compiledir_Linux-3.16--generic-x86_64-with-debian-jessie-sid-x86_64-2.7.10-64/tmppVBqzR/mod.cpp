...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_019191437f6503d31f686dc70d418788 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_019191437f6503d31f686dc70d418788() {
        ...
        ~__struct_compiled_op_019191437f6503d31f686dc70d418788(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_019191437f6503d31f686dc70d418788_executor(__struct_compiled_op_019191437f6503d31f686dc70d418788* self) {
            return self->run();
        }

        static void __struct_compiled_op_019191437f6503d31f686dc70d418788_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_019191437f6503d31f686dc70d418788*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_019191437f6503d31f686dc70d418788* struct_ptr = new __struct_compiled_op_019191437f6503d31f686dc70d418788();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_019191437f6503d31f686dc70d418788_executor), struct_ptr, __struct_compiled_op_019191437f6503d31f686dc70d418788_destructor);
  return thunk; }
...
PyMODINIT_FUNC init019191437f6503d31f686dc70d418788(void){
   import_array();
   (void) Py_InitModule("019191437f6503d31f686dc70d418788", MyMethods);
}
