...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_7a3ceb277268f3e16e25189d749158b5 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7a3ceb277268f3e16e25189d749158b5() {
        ...
        ~__struct_compiled_op_7a3ceb277268f3e16e25189d749158b5(void) {
            cleanup();
        }
...
npy_int64& V15_i = *V15_iter;
                  ...
                  {
npy_int64 V17_tmp1;
V17_tmp1 = V13_i * V15_i * V5_i;
npy_int64 V17_tmp2;
V17_tmp2 = V9_i * V5_i;
npy_int64 V17_tmp3;
V17_tmp3 = V11_i * V9_i * V5_i;
npy_int8 V17_tmp4;
V17_tmp4 = (V5_i == V7_i);
npy_int64 V17_tmp5;
V17_tmp5 = -V17_tmp1;
...
if (V17_tmp2 < 0) {
    if (V17_tmp3 < 0) {
        V17_tmp6 = ((-V17_tmp2) / (-V17_tmp3));
    } else {
        V17_tmp6 = - ((-V17_tmp2) / V17_tmp3) - ((THEANO_MACRO_MOD((-V17_tmp2), V17_tmp3) == 0) ? 0 : 1);
    }
} else {
    if (V17_tmp3 < 0) {
        V17_tmp6 = - (V17_tmp2 / (-V17_tmp3)) - ((THEANO_MACRO_MOD(V17_tmp2, (-V17_tmp3)) == 0) ? 0 : 1);
...
npy_int64 V17_tmp7;
V17_tmp7 = V17_tmp4 ? V17_tmp6 : V5_i;
npy_int64 V17_tmp8;
V17_tmp8 = V3_i * V17_tmp7;

if (V17_tmp8 < 0) {
    if (V17_tmp5 < 0) {
        V1_i = ((-V17_tmp8) / (-V17_tmp5));
    } else {
        V1_i = - ((-V17_tmp8) / V17_tmp5) - ((THEANO_MACRO_MOD((-V17_tmp8), V17_tmp5) == 0) ? 0 : 1);
    }
} else {
    if (V17_tmp5 < 0) {
        V1_i = - (V17_tmp8 / (-V17_tmp5)) - ((THEANO_MACRO_MOD(V17_tmp8, (-V17_tmp5)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7a3ceb277268f3e16e25189d749158b5_executor(__struct_compiled_op_7a3ceb277268f3e16e25189d749158b5* self) {
            return self->run();
        }

        static void __struct_compiled_op_7a3ceb277268f3e16e25189d749158b5_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7a3ceb277268f3e16e25189d749158b5*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7a3ceb277268f3e16e25189d749158b5* struct_ptr = new __struct_compiled_op_7a3ceb277268f3e16e25189d749158b5();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7a3ceb277268f3e16e25189d749158b5_executor), struct_ptr, __struct_compiled_op_7a3ceb277268f3e16e25189d749158b5_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7a3ceb277268f3e16e25189d749158b5(void){
   import_array();
   (void) Py_InitModule("7a3ceb277268f3e16e25189d749158b5", MyMethods);
}
