...
static __global__ void kernel_Sub_node_4d356678982b65a0ffc8b038547364d8_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, float * o0_data
	)
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_4d356678982b65a0ffc8b038547364d8_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_4d356678982b65a0ffc8b038547364d8_0(unsigned int numEls, const int d,
            const int * dims,
...
case 0: {
                ...
                kernel_Sub_node_4d356678982b65a0ffc8b038547364d8_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_4d356678982b65a0ffc8b038547364d8_0 Sub", cudaGetErrorString(err),
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_4d356678982b65a0ffc8b038547364d8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4d356678982b65a0ffc8b038547364d8() {
        ...
        ~__struct_compiled_op_4d356678982b65a0ffc8b038547364d8(void) {
            cleanup();
        }
...
// Op class GpuElemwise
...

        {
            ...
            if (callkernel_node_4d356678982b65a0ffc8b038547364d8_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4d356678982b65a0ffc8b038547364d8_executor(__struct_compiled_op_4d356678982b65a0ffc8b038547364d8* self) {
            return self->run();
        }

        static void __struct_compiled_op_4d356678982b65a0ffc8b038547364d8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4d356678982b65a0ffc8b038547364d8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4d356678982b65a0ffc8b038547364d8* struct_ptr = new __struct_compiled_op_4d356678982b65a0ffc8b038547364d8();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4d356678982b65a0ffc8b038547364d8_executor), struct_ptr, __struct_compiled_op_4d356678982b65a0ffc8b038547364d8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4d356678982b65a0ffc8b038547364d8(void){
   (void) Py_InitModule("4d356678982b65a0ffc8b038547364d8", MyMethods);
}
