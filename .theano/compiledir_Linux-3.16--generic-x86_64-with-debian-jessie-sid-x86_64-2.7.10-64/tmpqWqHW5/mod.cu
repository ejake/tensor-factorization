...
//    Input   0 CudaNdarrayType(float32, (True,))
//    Input   1 CudaNdarrayType(float32, vector)
//    Input   2 CudaNdarrayType(float32, (True,))
//    Input   3 CudaNdarrayType(float32, vector)
//    Output  0 CudaNdarrayType(float32, vector)
static __global__ void kernel_Composite_node_1be5065b94e767ad8506b2068b55a8eb_0_1(unsigned int numEls
	, const int dim0
...
//    Input   3 CudaNdarrayType(float32, vector)
//    Output  0 CudaNdarrayType(float32, vector)
static __global__ void kernel_Composite_node_1be5065b94e767ad8506b2068b55a8eb_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, const float * i3_data
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_1be5065b94e767ad8506b2068b55a8eb_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_1be5065b94e767ad8506b2068b55a8eb_0(unsigned int numEls, const int d,
            const int * dims,
...
int nd_collapse_[1] = {1};
                        ...
                        int nd_collapse_1[1] = {1};

can_collapse_node_1be5065b94e767ad8506b2068b55a8eb_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
...
nd_collapse_[i]=0;
                        ...
                        int nd_collapse_3[1] = {1};

can_collapse_node_1be5065b94e767ad8506b2068b55a8eb_0(nd_collapse, local_dims, local_str[3], nd_collapse_3);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Composite_node_1be5065b94e767ad8506b2068b55a8eb_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, i3_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_1be5065b94e767ad8506b2068b55a8eb_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_1be5065b94e767ad8506b2068b55a8eb_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_1be5065b94e767ad8506b2068b55a8eb_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_1be5065b94e767ad8506b2068b55a8eb_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], i3_data, local_str[3][0], o0_data, local_ostr[0][0])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb() {
        ...
        ~__struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //standard elemwise size checks
            ...
            int dims[1] = {1};
                ...
                int broadcasts_V3[1] = {1};
                

                int broadcasts_V5[1] = {0};
                

                int broadcasts_V7[1] = {1};
                

                int broadcasts_V9[1] = {0};
...

        {
            ...
            if (callkernel_node_1be5065b94e767ad8506b2068b55a8eb_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb_executor(__struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb* self) {
            return self->run();
        }

        static void __struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb* struct_ptr = new __struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb_executor), struct_ptr, __struct_compiled_op_1be5065b94e767ad8506b2068b55a8eb_destructor);
  return thunk; }
...
PyMODINIT_FUNC init1be5065b94e767ad8506b2068b55a8eb(void){
   (void) Py_InitModule("1be5065b94e767ad8506b2068b55a8eb", MyMethods);
}
