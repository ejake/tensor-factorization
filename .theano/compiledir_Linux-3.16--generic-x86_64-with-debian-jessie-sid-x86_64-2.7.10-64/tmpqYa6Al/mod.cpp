...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c7f73a758a92e52481364569a978db03 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c7f73a758a92e52481364569a978db03() {
        ...
        ~__struct_compiled_op_c7f73a758a92e52481364569a978db03(void) {
            cleanup();
        }
...
V25_1_tmp1 = ((V17_i)<(V25_tmp1)? (V17_i): ((V25_tmp1)<=(V17_i)? (V25_tmp1): nan("")));
npy_int64 V25_1_tmp2;
V25_1_tmp2 = V13_i - V15_i;
npy_int8 V25_1_tmp3;
V25_1_tmp3 = (V25_tmp1 < V5_i);
npy_int8 V25_1_tmp4;
V25_1_tmp4 = (V11_i > V5_i);
npy_int8 V25_1_tmp5;
V25_1_tmp5 = (V25_1_tmp3 & V25_1_tmp4);
npy_int64 V25_1_tmp6;
V25_1_tmp6 = V25_1_tmp5 ? V25_1_tmp2 : V25_1_tmp1;
V25_tmp2 = V3_i ? V5_i : V25_1_tmp6;
}

npy_int64 V25_tmp3;
{
npy_int64 V25_2_tmp1;
V25_2_tmp1 = V25_tmp2 + V19_i + V15_i;
npy_int8 V25_2_tmp2;
V25_2_tmp2 = (V25_tmp2 < V5_i);
...
{
npy_int8 V25_3_tmp1;
V25_3_tmp1 = (V25_tmp3 < V5_i);
V25_tmp4 = V25_3_tmp1 ? V21_i : V25_tmp3;
}

npy_int8 V25_tmp5;
V25_tmp5 = (V25_tmp4 >= V23_i);
V1_i = V25_tmp5 ? V23_i : V25_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c7f73a758a92e52481364569a978db03_executor(__struct_compiled_op_c7f73a758a92e52481364569a978db03* self) {
            return self->run();
        }

        static void __struct_compiled_op_c7f73a758a92e52481364569a978db03_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c7f73a758a92e52481364569a978db03*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c7f73a758a92e52481364569a978db03* struct_ptr = new __struct_compiled_op_c7f73a758a92e52481364569a978db03();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c7f73a758a92e52481364569a978db03_executor), struct_ptr, __struct_compiled_op_c7f73a758a92e52481364569a978db03_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc7f73a758a92e52481364569a978db03(void){
   import_array();
   (void) Py_InitModule("c7f73a758a92e52481364569a978db03", MyMethods);
}
