...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a() {
        ...
        ~__struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a(void) {
            cleanup();
        }
...
if (V9_tmp2 < 0) {
    if (V9_tmp3 < 0) {
        ...
        V1_i = - ((-V9_tmp2) / V9_tmp3) - ((THEANO_MACRO_MOD((-V9_tmp2), V9_tmp3) == 0) ? 0 : 1);
    }
} else {
    if (V9_tmp3 < 0) {
        V1_i = - (V9_tmp2 / (-V9_tmp3)) - ((THEANO_MACRO_MOD(V9_tmp2, (-V9_tmp3)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a_executor(__struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a* self) {
            return self->run();
        }

        static void __struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a* struct_ptr = new __struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a_executor), struct_ptr, __struct_compiled_op_35d6be9bbd7f10f133ca265df8314b9a_destructor);
  return thunk; }
...
PyMODINIT_FUNC init35d6be9bbd7f10f133ca265df8314b9a(void){
   import_array();
   (void) Py_InitModule("35d6be9bbd7f10f133ca265df8314b9a", MyMethods);
}
