...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f() {
        ...
        ~__struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f(void) {
            cleanup();
        }
...
V19_tmp2 = (V13_i > V5_i);
npy_int64 V19_tmp3;
V19_tmp3 = ((V17_i)<(V19_tmp1)? (V17_i): ((V19_tmp1)<=(V17_i)? (V19_tmp1): nan("")));
npy_int8 V19_tmp4;
V19_tmp4 = (V19_tmp1 < V5_i);
npy_int8 V19_tmp5;
V19_tmp5 = (V19_tmp4 & V19_tmp2);
npy_int64 V19_tmp6;
V19_tmp6 = V19_tmp5 ? V15_i : V19_tmp3;
V1_i = V3_i ? V5_i : V19_tmp6;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f_executor(__struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f* self) {
            return self->run();
        }

        static void __struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f* struct_ptr = new __struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f_executor), struct_ptr, __struct_compiled_op_2dff8a460ab325e5e6ed7a8ef0420b1f_destructor);
  return thunk; }
...
PyMODINIT_FUNC init2dff8a460ab325e5e6ed7a8ef0420b1f(void){
   import_array();
   (void) Py_InitModule("2dff8a460ab325e5e6ed7a8ef0420b1f", MyMethods);
}
