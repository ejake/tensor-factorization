...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_946dc2054b01246a130afd8566a709ba {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_946dc2054b01246a130afd8566a709ba() {
        ...
        ~__struct_compiled_op_946dc2054b01246a130afd8566a709ba(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_946dc2054b01246a130afd8566a709ba_executor(__struct_compiled_op_946dc2054b01246a130afd8566a709ba* self) {
            return self->run();
        }

        static void __struct_compiled_op_946dc2054b01246a130afd8566a709ba_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_946dc2054b01246a130afd8566a709ba*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_946dc2054b01246a130afd8566a709ba* struct_ptr = new __struct_compiled_op_946dc2054b01246a130afd8566a709ba();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_946dc2054b01246a130afd8566a709ba_executor), struct_ptr, __struct_compiled_op_946dc2054b01246a130afd8566a709ba_destructor);
  return thunk; }
...
PyMODINIT_FUNC init946dc2054b01246a130afd8566a709ba(void){
   import_array();
   (void) Py_InitModule("946dc2054b01246a130afd8566a709ba", MyMethods);
}
