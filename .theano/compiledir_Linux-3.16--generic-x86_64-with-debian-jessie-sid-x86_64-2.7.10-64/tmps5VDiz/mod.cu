...
#define INTMOD_POW2(a, b) (a & ((1<<b)-1))
        // GpuElemwise{Composite{Cast{float32}(AND(GE(i0, i1), LE(i0, i2)))}}[(0, 0)]
...
static __global__ void kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_1(unsigned int numEls
	, const int dim0
...
//    Input   2 CudaNdarrayType(float32, (True, True))
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_2(unsigned int numEls
...
//    Input   2 CudaNdarrayType(float32, (True, True))
//    Output  0 CudaNdarrayType(float32, matrix)
static __global__ void kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, const float * i2_data
	, float * o0_data
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_24fa2ebf8b1c817c673d6a766af002b8_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_24fa2ebf8b1c817c673d6a766af002b8_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_24fa2ebf8b1c817c673d6a766af002b8_0(nd_collapse, local_dims, local_str[0], nd_collapse_0);
...
case 0: {
                ...
                kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, i2_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_24fa2ebf8b1c817c673d6a766af002b8_0 Composite", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_24fa2ebf8b1c817c673d6a766af002b8_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], i2_data, local_str[2][0], o0_data, local_ostr[0][0])");
                    return -1;
...
case 2: {
                ...
                kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_2<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], o0_data, local_ostr[0][0], local_ostr[0][1]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_24fa2ebf8b1c817c673d6a766af002b8_0 Composite", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Composite_node_24fa2ebf8b1c817c673d6a766af002b8_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], local_dims[1], i0_data, local_str[0][0], local_str[0][1], i1_data, local_str[1][0], local_str[1][1], i2_data, local_str[2][0], local_str[2][1], o0_data, local_ostr[0][0], local_ostr[0][1])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8() {
        ...
        ~__struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8(void) {
            cleanup();
        }
...
// Op class GpuElemwise
...

        {
            ...
            if (callkernel_node_24fa2ebf8b1c817c673d6a766af002b8_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8_executor(__struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8* self) {
            return self->run();
        }

        static void __struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8* struct_ptr = new __struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8_executor), struct_ptr, __struct_compiled_op_24fa2ebf8b1c817c673d6a766af002b8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init24fa2ebf8b1c817c673d6a766af002b8(void){
   (void) Py_InitModule("24fa2ebf8b1c817c673d6a766af002b8", MyMethods);
}
