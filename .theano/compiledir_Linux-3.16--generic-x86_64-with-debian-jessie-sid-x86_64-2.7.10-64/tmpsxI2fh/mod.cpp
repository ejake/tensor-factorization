...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_aae8d39514c7a213640362e0dcf99298 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_aae8d39514c7a213640362e0dcf99298() {
        ...
        ~__struct_compiled_op_aae8d39514c7a213640362e0dcf99298(void) {
            cleanup();
        }
...
V11_tmp1 = (V3_i == V5_i);
npy_int64 V11_tmp2;
V11_tmp2 = V11_tmp1 ? V7_i : V3_i;

if (V11_tmp2 < 0) {
    if (V9_i < 0) {
        V1_i = ((-V11_tmp2) / (-V9_i));
    } else {
        V1_i = - ((-V11_tmp2) / V9_i) - ((THEANO_MACRO_MOD((-V11_tmp2), V9_i) == 0) ? 0 : 1);
    }
} else {
    if (V9_i < 0) {
        V1_i = - (V11_tmp2 / (-V9_i)) - ((THEANO_MACRO_MOD(V11_tmp2, (-V9_i)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_aae8d39514c7a213640362e0dcf99298_executor(__struct_compiled_op_aae8d39514c7a213640362e0dcf99298* self) {
            return self->run();
        }

        static void __struct_compiled_op_aae8d39514c7a213640362e0dcf99298_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_aae8d39514c7a213640362e0dcf99298*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_aae8d39514c7a213640362e0dcf99298* struct_ptr = new __struct_compiled_op_aae8d39514c7a213640362e0dcf99298();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_aae8d39514c7a213640362e0dcf99298_executor), struct_ptr, __struct_compiled_op_aae8d39514c7a213640362e0dcf99298_destructor);
  return thunk; }
...
PyMODINIT_FUNC initaae8d39514c7a213640362e0dcf99298(void){
   import_array();
   (void) Py_InitModule("aae8d39514c7a213640362e0dcf99298", MyMethods);
}
