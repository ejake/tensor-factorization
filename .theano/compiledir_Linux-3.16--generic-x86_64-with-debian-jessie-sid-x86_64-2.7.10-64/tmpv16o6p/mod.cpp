...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5() {
        ...
        ~__struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5(void) {
            cleanup();
        }
...
V13_stride0, V13_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V13_stride_l1 = init_strides[5][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V13_stride_l0 = init_strides[5][V7_loops_rit->second];
            ++V7_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5_executor(__struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5* self) {
            return self->run();
        }

        static void __struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5* struct_ptr = new __struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5_executor), struct_ptr, __struct_compiled_op_fd9a10ab7a93beb2a018c81d48b15bc5_destructor);
  return thunk; }
...
PyMODINIT_FUNC initfd9a10ab7a93beb2a018c81d48b15bc5(void){
   import_array();
   (void) Py_InitModule("fd9a10ab7a93beb2a018c81d48b15bc5", MyMethods);
}
