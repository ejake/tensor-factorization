...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_82618a53870652863279a1b294468d3a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_82618a53870652863279a1b294468d3a() {
        ...
        ~__struct_compiled_op_82618a53870652863279a1b294468d3a(void) {
            cleanup();
        }
...
V9_tmp1 = sqrt(V3_i);
npy_float64 V9_tmp2;
V9_tmp2 = V5_i / V9_tmp1;
npy_int8 V9_tmp3;
V9_tmp3 = (V9_tmp1 < V5_i);
V1_i = V9_tmp3 ? V7_i : V9_tmp2;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_82618a53870652863279a1b294468d3a_executor(__struct_compiled_op_82618a53870652863279a1b294468d3a* self) {
            return self->run();
        }

        static void __struct_compiled_op_82618a53870652863279a1b294468d3a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_82618a53870652863279a1b294468d3a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_82618a53870652863279a1b294468d3a* struct_ptr = new __struct_compiled_op_82618a53870652863279a1b294468d3a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_82618a53870652863279a1b294468d3a_executor), struct_ptr, __struct_compiled_op_82618a53870652863279a1b294468d3a_destructor);
  return thunk; }
...
PyMODINIT_FUNC init82618a53870652863279a1b294468d3a(void){
   import_array();
   (void) Py_InitModule("82618a53870652863279a1b294468d3a", MyMethods);
}
