...
static __global__ void kernel_Add_node_f8709d154c0eec850230849fad8a043c_0_1(unsigned int numEls
	, const int dim0
...
//    Input   1 CudaNdarrayType(float32, vector)
//    Output  0 CudaNdarrayType(float32, vector)
static __global__ void kernel_Add_node_f8709d154c0eec850230849fad8a043c_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, float * o0_data
	)
...
o0_data[i] = o0_i;
        ...
        static void can_collapse_node_f8709d154c0eec850230849fad8a043c_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_f8709d154c0eec850230849fad8a043c_0(unsigned int numEls, const int d,
            const int * dims,
...
can_collapse_node_f8709d154c0eec850230849fad8a043c_0(nd_collapse, local_dims, local_str[0], nd_collapse_0);
...
can_collapse_node_f8709d154c0eec850230849fad8a043c_0(nd_collapse, local_dims, local_str[1], nd_collapse_1);
for(int i=0;i<nd_collapse;i++){
...
case 0: {
                ...
                kernel_Add_node_f8709d154c0eec850230849fad8a043c_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_f8709d154c0eec850230849fad8a043c_0 Add", cudaGetErrorString(err),
...
case 1: {
                ...
                kernel_Add_node_f8709d154c0eec850230849fad8a043c_0_1<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], o0_data, local_ostr[0][0]);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_f8709d154c0eec850230849fad8a043c_0 Add", cudaGetErrorString(err),
                         n_blocks, threads_per_block,
                         "kernel_Add_node_f8709d154c0eec850230849fad8a043c_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, local_dims[0], i0_data, local_str[0][0], i1_data, local_str[1][0], o0_data, local_ostr[0][0])");
                    return -1;
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_f8709d154c0eec850230849fad8a043c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f8709d154c0eec850230849fad8a043c() {
        ...
        ~__struct_compiled_op_f8709d154c0eec850230849fad8a043c(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        goto __label_7;};
            ...
            if (CudaNdarray_alloc_contiguous(V1, 1, dims))
            {
                //error string already set
                Py_DECREF(V1);
                V1 = NULL;
...

        {
            ...
            if (callkernel_node_f8709d154c0eec850230849fad8a043c_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f8709d154c0eec850230849fad8a043c_executor(__struct_compiled_op_f8709d154c0eec850230849fad8a043c* self) {
            return self->run();
        }

        static void __struct_compiled_op_f8709d154c0eec850230849fad8a043c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f8709d154c0eec850230849fad8a043c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f8709d154c0eec850230849fad8a043c* struct_ptr = new __struct_compiled_op_f8709d154c0eec850230849fad8a043c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f8709d154c0eec850230849fad8a043c_executor), struct_ptr, __struct_compiled_op_f8709d154c0eec850230849fad8a043c_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf8709d154c0eec850230849fad8a043c(void){
   (void) Py_InitModule("f8709d154c0eec850230849fad8a043c", MyMethods);
}
