...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3827546e4e18ae4ca535880c02eb8710 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3827546e4e18ae4ca535880c02eb8710() {
        ...
        ~__struct_compiled_op_3827546e4e18ae4ca535880c02eb8710(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3827546e4e18ae4ca535880c02eb8710_executor(__struct_compiled_op_3827546e4e18ae4ca535880c02eb8710* self) {
            return self->run();
        }

        static void __struct_compiled_op_3827546e4e18ae4ca535880c02eb8710_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3827546e4e18ae4ca535880c02eb8710*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3827546e4e18ae4ca535880c02eb8710* struct_ptr = new __struct_compiled_op_3827546e4e18ae4ca535880c02eb8710();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3827546e4e18ae4ca535880c02eb8710_executor), struct_ptr, __struct_compiled_op_3827546e4e18ae4ca535880c02eb8710_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3827546e4e18ae4ca535880c02eb8710(void){
   import_array();
   (void) Py_InitModule("3827546e4e18ae4ca535880c02eb8710", MyMethods);
}
