...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3() {
        ...
        ~__struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3_executor(__struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3* self) {
            return self->run();
        }

        static void __struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3* struct_ptr = new __struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3_executor), struct_ptr, __struct_compiled_op_6b8ae499ce1bef1b19a956578537d0d3_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6b8ae499ce1bef1b19a956578537d0d3(void){
   import_array();
   (void) Py_InitModule("6b8ae499ce1bef1b19a956578537d0d3", MyMethods);
}
