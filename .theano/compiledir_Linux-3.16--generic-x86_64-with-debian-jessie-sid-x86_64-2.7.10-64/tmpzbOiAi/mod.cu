...
static __global__ void kernel_TrueDiv_node_470efad226875fcc7f533ccfb3ff4710_0_Ccontiguous (unsigned int numEls
	, const float * i0_data
	, const float * i1_data
	, float * o0_data
	)
...
npy_float32 o0_i;
        o0_i = ii_i0_value / ii_i1_value;
o0_data[i] = o0_i;
    }
}

        static void can_collapse_node_470efad226875fcc7f533ccfb3ff4710_0(int nd, const int * dims, const int * strides, int collapse[])
        {
        ...
        static int callkernel_node_470efad226875fcc7f533ccfb3ff4710_0(unsigned int numEls, const int d,
            const int * dims,
...
case 0: {
                ...
                kernel_TrueDiv_node_470efad226875fcc7f533ccfb3ff4710_0_Ccontiguous<<<n_blocks, threads_per_block>>>(numEls, i0_data, i1_data, o0_data);
                ...
                if( cudaSuccess != err)
                {
                    PyErr_Format(PyExc_RuntimeError, "Cuda error: %s: %s.\n    n_blocks=%i threads_per_block=%i\n   Call: %s\n",
                         "GpuElemwise node_470efad226875fcc7f533ccfb3ff4710_0 TrueDiv", cudaGetErrorString(err),
...
return -2;
    ...
    namespace {
    struct __struct_compiled_op_470efad226875fcc7f533ccfb3ff4710 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_470efad226875fcc7f533ccfb3ff4710() {
        ...
        ~__struct_compiled_op_470efad226875fcc7f533ccfb3ff4710(void) {
            cleanup();
        }
...
// Op class GpuElemwise
        ...
        //std::cerr << "C_CODE TrueDiv checking input V3\n";
        if (0 != V3->nd)
        {
        ...
        for (int i = 0; i< 0; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE TrueDiv checking input V3 failed\n";
        ...
        //std::cerr << "C_CODE TrueDiv checking input V5\n";
        if (0 != V5->nd)
        {
            PyErr_Format(PyExc_TypeError,
        ...
        for (int i = 0; i< 0; ++i)
        {
            ...
            {
                //std::cerr << "C_CODE TrueDiv checking input V5 failed\n";
                PyErr_Format(PyExc_ValueError,
                             "GpuElemwise. Input dimension mis-match. Input"
...

        {
            ...
            if (callkernel_node_470efad226875fcc7f533ccfb3ff4710_0(1, 0, dims
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_470efad226875fcc7f533ccfb3ff4710_executor(__struct_compiled_op_470efad226875fcc7f533ccfb3ff4710* self) {
            return self->run();
        }

        static void __struct_compiled_op_470efad226875fcc7f533ccfb3ff4710_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_470efad226875fcc7f533ccfb3ff4710*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_470efad226875fcc7f533ccfb3ff4710* struct_ptr = new __struct_compiled_op_470efad226875fcc7f533ccfb3ff4710();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_470efad226875fcc7f533ccfb3ff4710_executor), struct_ptr, __struct_compiled_op_470efad226875fcc7f533ccfb3ff4710_destructor);
  return thunk; }
...
PyMODINIT_FUNC init470efad226875fcc7f533ccfb3ff4710(void){
   (void) Py_InitModule("470efad226875fcc7f533ccfb3ff4710", MyMethods);
}
