...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_eb0fb47d559a350a019b9b830592b52c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_eb0fb47d559a350a019b9b830592b52c() {
        ...
        ~__struct_compiled_op_eb0fb47d559a350a019b9b830592b52c(void) {
            cleanup();
        }
...
V21_1_tmp1 = V21_tmp1 + V15_i + V17_i;
npy_int8 V21_1_tmp2;
...
npy_int8 V21_tmp3;
V21_tmp3 = (V21_tmp2 < V5_i);
V1_i = V21_tmp3 ? V19_i : V21_tmp2;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_eb0fb47d559a350a019b9b830592b52c_executor(__struct_compiled_op_eb0fb47d559a350a019b9b830592b52c* self) {
            return self->run();
        }

        static void __struct_compiled_op_eb0fb47d559a350a019b9b830592b52c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_eb0fb47d559a350a019b9b830592b52c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_eb0fb47d559a350a019b9b830592b52c* struct_ptr = new __struct_compiled_op_eb0fb47d559a350a019b9b830592b52c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_eb0fb47d559a350a019b9b830592b52c_executor), struct_ptr, __struct_compiled_op_eb0fb47d559a350a019b9b830592b52c_destructor);
  return thunk; }
...
PyMODINIT_FUNC initeb0fb47d559a350a019b9b830592b52c(void){
   import_array();
   (void) Py_InitModule("eb0fb47d559a350a019b9b830592b52c", MyMethods);
}
